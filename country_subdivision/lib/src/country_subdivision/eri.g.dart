...
const countrySubdivisionERIAN = CountrySubdivision(
  alpha2: 'ER',
  alpha3: 'ERI',
  code: 'AN',
  name: 'Anseba',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 16.4745531, longitude: 37.8087693),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 17.557606, longitude: 38.8872519),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.521509, longitude: 36.8874469)),
  translations: {
    'en': 'Anseba',
    'ar': 'إقليم أنسبا',
    'bg': 'Ансеба',
...
const countrySubdivisionERIDK = CountrySubdivision(
  alpha2: 'ER',
  alpha3: 'ERI',
  code: 'DK',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.5137103, longitude: 41.7606472),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.0200658, longitude: 43.1486397),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.359562, longitude: 40.329559)),
  translations: {
    'en': 'Southern Red Sea',
    ...
    'yue_Hans': '南红海地区',
    'ccp': '𑄘𑄧𑄊𑄨𑄚𑄴𑄟𑄬𑄇𑄴𑄈𑄬 𑄢𑄋 𑄥𑄉𑄧𑄢𑄴',
    'yue': '南紅海地區',
    'no': 'Debubawi Keyih Bahri'
  },
  type: 'region',
);
const countrySubdivisionERIDU = CountrySubdivision(
  alpha2: 'ER',
  alpha3: 'ERI',
  code: 'DU',
  name: 'Debub',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 14.9478692, longitude: 39.1543677),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.2706559, longitude: 39.670701),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.408369, longitude: 38.222448)),
  translations: {
    'en': 'Debub',
    'ar': 'منطقة الجنوب',
    'bg': 'Южен регион',
...
const countrySubdivisionERIGB = CountrySubdivision(
  alpha2: 'ER',
  alpha3: 'ERI',
  code: 'GB',
  name: 'Gash-Barka',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 15.4068825, longitude: 37.6386622),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.285809, longitude: 38.7686061),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.1124271, longitude: 36.4387661)),
  translations: {
    'en': 'Gash-Barka',
    'ar': 'إقليم غاش-باركا',
    'bg': 'Гаш-Барка',
...
const countrySubdivisionERIMA = CountrySubdivision(
  alpha2: 'ER',
  alpha3: 'ERI',
  code: 'MA',
  name: 'Maakel [Maekel]',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 15.3551409, longitude: 38.8623683),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.587143, longitude: 39.0490999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.116929, longitude: 38.693163)),
  translations: {
    'en': 'Maekel',
    'ar': 'المنطقة المركزية',
    'bg': 'Централен регион',
...
const countrySubdivisionERISK = CountrySubdivision(
  alpha2: 'ER',
  alpha3: 'ERI',
  code: 'SK',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 16.2583997, longitude: 38.8205454),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 18.003086, longitude: 41.2974091),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.337765, longitude: 37.9696809)),
  translations: {
    'en': 'Northern Red Sea',
