...
const countrySubdivisionPOL02 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '02',
  name: 'Dolnośląskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 51.13398609999999, longitude: 16.8841961),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.8047592, longitude: 17.798917),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 50.09634, longitude: 14.816831)),
  translations: {
    ...
    'az': 'Aşağı Sileziya voyevodalığı',
    'bs': 'Donjošlesko vojvodstvo',
    'ceb': 'Województwo Dolnośląskie',
    'hy': 'Ներքինսիլեզյան վոևոդություն',
    'jv': 'Provinsi Silesia Hilir',
    'mk': 'Долношлеско Војводство',
    'ps': 'سیلزي سفلي',
    'yue': '下西里西亞省',
    'yue_Hans': '下西里西亚省'
  },
...
const countrySubdivisionPOL04 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '04',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 53.1648363, longitude: 18.4834224),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.7809987, longitude: 19.7618466),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 52.33079, longitude: 17.2472674)),
  translations: {
    ...
    'zh': '庫亞維-波美拉尼亞省',
    'no': 'Kujaviskpommerske voivodskap',
    'az': 'Kuyaviya-Pomoraniya voyevodluğu',
    'bs': 'Kujavsko-pomeransko vojvodstvo',
    'ceb': 'Województwo Kujawsko-Pomorskie',
    'jv': 'Provinsi Kuyawia-Pomerania',
    'mk': 'Кујавско-поморско Војводство',
    'yue': '庫亞維-波美拉尼亞省',
    'yue_Hans': '库亚维-波美拉尼亚省'
  },
  type: 'voivodeship',
);
const countrySubdivisionPOL06 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '06',
  name: 'Lubelskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 51.2493519, longitude: 23.1011392),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 52.2879201, longitude: 24.1458931),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 50.251603, longitude: 21.6171249)),
  translations: {
    ...
    'vi': 'Lubelskie',
    'zh': '卢布林省',
    'no': 'Lublin voivodskap',
    'az': 'Lyublin voyevodluğu',
    'bs': 'Lublinsko vojvodstvo',
    'ceb': 'Województwo Lubelskie',
    'jv': 'Provinsi Lublin',
    'mk': 'Лублинско Војводство',
    'ps': 'لوبلین ولایت',
    'yue': '盧布林省',
    'yue_Hans': '卢布林省'
  },
...
const countrySubdivisionPOL08 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '08',
  name: 'Lubuskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 52.2274612, longitude: 15.2559103),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.1239582, longitude: 16.4163811),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.363138, longitude: 14.534127)),
  translations: {
    'ar': 'محافظة لوبوسكي',
    ...
    'vi': 'Lubuskie',
    'zh': '盧布斯卡省',
    'no': 'Lubusz voivodskap',
    'az': 'Lyubuş voyevodluğu',
    'bs': 'Lubusko vojvodstvo',
    'ceb': 'Województwo Lubuskie',
    'jv': 'Provinsi Lubusz',
    'mk': 'Лубушко Војводство',
    'ps': 'لوبوسکي',
    'yue': '盧布斯卡省',
    'yue_Hans': '卢布斯卡省'
  },
...
const countrySubdivisionPOL10 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '10',
  name: 'Łódzkie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 51.4634771, longitude: 19.1726974),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 52.3940561, longitude: 20.6591903),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 50.8430329, longitude: 18.0750521)),
  translations: {
    'ar': 'محافظة وودج',
    ...
    'no': 'Łódź voivodskap',
    'az': 'Lodz voyevodluğu',
    'bs': 'Lodzko vojvodstvo',
    'ceb': 'Województwo Łódzkie',
    'cy': 'Łódź Voivodeship',
    'hy': 'Լոձի վոևոդություն',
    'jv': 'Provinsi Lodz',
    'mk': 'Лоѓско Војводство',
    'ps': 'ووتسکي',
    'yue': '胡芝省',
    'yue_Hans': '胡芝省'
  },
...
const countrySubdivisionPOL12 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '12',
  name: 'Małopolskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 49.72253060000001, longitude: 20.2503359),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 50.5200442, longitude: 21.4213826),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 49.1785791, longitude: 19.083192)),
  translations: {
    ...
    'vi': 'Małopolskie',
    'zh': '小波兰省',
    'no': 'Lillepolske voivodskap',
    'az': 'Kiçik Polşa voyevodluğu',
    'bs': 'Malopoljsko vojvodstvo',
    'ceb': 'Województwo Małopolskie',
    'jv': 'Provinsi Malopolskie',
    'mk': 'Малополско Војводство',
    'mn': 'Бага Польш муж',
    'ps': 'کوچینی پولنډ ولایت',
    'yue': '細波蘭省',
    'yue_Hans': '细波兰省'
  },
  type: 'voivodeship',
);
const countrySubdivisionPOL14 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '14',
  name: 'Mazowieckie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 51.8927182, longitude: 21.0021679),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.4818919, longitude: 23.1283212),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.0132082, longitude: 19.2592569)),
  translations: {
    ...
    'vi': 'Mazowieckie',
    'zh': '馬佐夫舍省',
    'no': 'Masoviske voivodskap',
    'az': 'Mazovets voyevodluğu',
    'bs': 'Mazovjecko vojvodstvo',
    'ceb': 'Województwo Mazowieckie',
    'jv': 'Provinsi Mazowia',
    'mk': 'Мазовско Војводство',
    'ps': 'ماسوویان',
    'sl': 'Mazovijsko vojvodstvo',
    'yue': '馬索維亞省',
    'yue_Hans': '马索维亚省'
  },
  type: 'voivodeship',
);
const countrySubdivisionPOL16 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '16',
  name: 'Opolskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 50.8003761, longitude: 17.937989),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.1945111, longitude: 18.6957862),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 49.9725265, longitude: 16.9087264)),
  translations: {
    'ar': 'محافظة أوبولي',
    ...
    'zh': '奧波萊省',
    'no': 'Opole voivodskap',
    'az': 'Opole voyevodluğu',
    'bs': 'Opolsko vojvodstvo',
    'ceb': 'Województwo Opolskie',
    'hy': 'Օպոլյան վոյևոդություն',
    'jv': 'Provinsi Opole',
    'mk': 'Ополско Војводство',
    'mn': 'Ополе муж',
    'yue': '奧波萊省',
    'yue_Hans': '奥波莱省'
  },
...
const countrySubdivisionPOL18 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '18',
  name: 'Podkarpackie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 50.0574749, longitude: 22.0895691),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 50.8181161, longitude: 23.5476409),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 49.0020252, longitude: 21.1423457)),
  translations: {
    ...
    'vi': 'Podkarpackie',
    'zh': '喀尔巴阡山省',
    'no': 'Subkarpatiske voivodskap',
    'az': 'Alt Karpat voyevodluğu',
    'bs': 'Potkarpatsko vojvodstvo',
    'ceb': 'Województwo Podkarpackie',
    'jv': 'Provinsi Subkarpathia',
    'mk': 'Поткарпатско Војводство',
    'mn': 'Подкарпат муж',
    'ps': 'پودکارپاتسکیه',
    'yue': '喀爾巴阡山省',
    'yue_Hans': '喀尔巴阡山省'
...
const countrySubdivisionPOL20 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '20',
  name: 'Podlaskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 53.0697159, longitude: 22.9674639),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 54.409889, longitude: 23.9462697),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 52.2800528, longitude: 21.5942443)),
  translations: {
    ...
    'vi': 'Podlaskie',
    'zh': '波德拉謝省',
    'no': 'Podlasie voivodskap',
    'az': 'Podlyaskoye voyevodluğu',
    'bs': 'Podlasko vojvodstvo',
    'ceb': 'Województwo Podlaskie',
    'hy': 'Պոդլյասկի վոյեվոդություն',
    'jv': 'Provinsi Podlachia',
    'mk': 'Подласко Војводство',
    'mn': 'Подласки муж',
    'ps': 'پولادسکي',
    'yue': '波德拉謝省',
    'yue_Hans': '波德拉谢省'
...
const countrySubdivisionPOL22 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '22',
  name: 'Pomorskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 54.2944252, longitude: 18.1531164),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 54.83572969999999, longitude: 19.6493699),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.49067179999999, longitude: 16.699129)),
  translations: {
    ...
    'vi': 'Pomorskie',
    'zh': '濱海省',
    'no': 'Pommerske voivodskap',
    'az': 'Pomoraniya voyevodluğu',
    'bs': 'Pomeransko vojvodstvo',
    'ceb': 'Województwo Pomorskie',
    'jv': 'Provinsi Pomerania',
    'mk': 'Поморско Војводство',
    'ps': 'پومراني',
    'yue': '波美拉尼亞省',
    'yue_Hans': '波美拉尼亚省'
  },
...
const countrySubdivisionPOL24 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '24',
  name: 'Śląskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 50.5716595, longitude: 19.3219768),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.0993559, longitude: 19.9739915),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 49.393975, longitude: 18.03475)),
  translations: {
    'ar': 'محافظة سيليزيا',
    ...
    'az': 'Sileziya voyevodluğu',
    'bs': 'Šlesko vojvodstvo',
    'ceb': 'Województwo Śląskie',
    'cy': 'Silesian Voivodeship',
    'hy': 'Սիլեզիայի վոյեվոդություն',
    'jv': 'Provinsi Silesia',
    'mk': 'Шлеско Војводство',
    'mn': 'Силези муж',
    'ps': 'سیلسیان',
    'sl': 'Šlezijsko vojvodstvo',
    'yue': '西里西亞省',
    'yue_Hans': '西里西亚省'
  },
  type: 'voivodeship',
);
const countrySubdivisionPOL26 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '26',
  name: 'Świętokrzyskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 50.6261041, longitude: 20.9406279),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.3421558, longitude: 21.8703061),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 50.1855379, longitude: 19.7044002)),
  translations: {
    ...
    'az': 'Svetokrişko voyevodluğu',
    'bs': 'Svetokriško vojvodstvo',
    'ceb': 'Województwo Świętokrzyskie',
    'jv': 'Provinsi Święty Krzyż',
    'mk': 'Светокришко Војводство',
    'ps': 'اشوی داشکسیه',
    'yue': '聖十字省',
    'yue_Hans': '圣十字省'
  },
...
const countrySubdivisionPOL28 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '28',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 53.8671117, longitude: 20.702786),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 54.4533097, longitude: 22.8058724),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.1399971, longitude: 19.128516)),
  translations: {
    ...
    'zh': '瓦爾米亞-馬祖里省',
    'no': 'Ermlandskmasuriske voivodskap',
    'az': 'Varmiya-Mazuriya voyevodluğu',
    'bs': 'Varminsko-mazursko vojvodstvo',
    'ceb': 'Województwo Warmińsko-Mazurskie',
    'jv': 'Provinsi Warmia-Mazuria',
    'mk': 'Варминско-мазурско Војводство',
    'yue': '華爾米亞-馬祖里省',
    'yue_Hans': '华尔米亚-马祖里省'
  },
  type: 'voivodeship',
);
const countrySubdivisionPOL30 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '30',
  name: 'Wielkopolskie',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 52.279986, longitude: 17.3522939),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.6559175, longitude: 19.103349),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.1037882, longitude: 15.7789647)),
  translations: {
    ...
    'vi': 'Wielkopolskie',
    'zh': '大波兰省',
    'no': 'Storpolske voivodskap',
    'az': 'Böyük Polşa voyevodluğu',
    'bs': 'Velikopoljsko vojvodstvo',
    'ceb': 'Województwo Wielkopolskie',
    'jv': 'Provinsi Wielkopolskie',
...
const countrySubdivisionPOL32 = CountrySubdivision(
  alpha2: 'PL',
  alpha3: 'POL',
  code: '32',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 53.46578909999999, longitude: 15.1822581),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 54.5690916, longitude: 16.9822089),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 52.62466939999999, longitude: 14.1223531)),
  translations: {
    ...
    'zh': '西波美拉尼亚省',
    'no': 'Vestpommerske voivodskap',
    'az': 'Qərbi Pomeraniya voyevodluğu',
    'bs': 'Zapadnopomeransko vojvodstvo',
    'ceb': 'Województwo Zachodniopomorskie',
    'jv': 'Provinsi Pomerania Kulon',
    'mk': 'Западнопоморско Војводство',
    'ps': 'لویدیځ پومراني',
    'yue': '西波美拉尼亞省',
    'yue_Hans': '西波美拉尼亚省'
  },
