...
const countrySubdivisionCANAB = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'AB',
  name: 'Alberta',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 60.00006209999999, longitude: -109.9998551),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.9966671, longitude: -120.0005219)),
  translations: {
    'en': 'Alberta',
    'af': 'Alberta',
    'ar': 'ألبرتا',
...
const countrySubdivisionCANBC = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'BC',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 60.0001489, longitude: -114.0542211),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.3089123, longitude: -139.0570702)),
  translations: {
    'en': 'British Columbia',
    'af': 'Brits-Columbië',
    ...
    'no': 'Britisk Columbia',
    'kk': 'Британдық Колумбия',
    'ps': 'برتانوي کولمبيا'
  },
  type: 'province',
);
const countrySubdivisionCANMB = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'MB',
  name: 'Manitoba',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 60.0001031, longitude: -88.9852265),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.998861, longitude: -102.0000041)),
  translations: {
    'en': 'Manitoba',
    'af': 'Manitoba',
    'ar': 'مانيتوبا',
...
const countrySubdivisionCANNB = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'NB',
  name: 'New Brunswick',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.5653163, longitude: -66.46191639999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.1735157, longitude: -63.7706403),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.499574, longitude: -69.05339289999999)),
  translations: {
    'en': 'New Brunswick',
    'af': 'Nieu-Brunswyk',
    'ar': 'نيو برونزويك',
    ...
    'no': 'New Brunswick',
    'kk': 'Нью-Брансуик',
    'ml': 'ന്യൂ ബ്രൺസ്വിക്ക്'
  },
  type: 'province',
);
const countrySubdivisionCANNL = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'NL',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 53.1355091, longitude: -57.6604364),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 60.37627010000001, longitude: -52.6194086),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.6114571, longitude: -67.8216849)),
  translations: {
    ...
    'si': 'නිව් ෆවුන්ඩ්ලන්ඩ් සහ ලබ්‍රඩොර්',
    ...
    'ccp': '𑄚𑄨𑄅𑄪𑄜𑄅𑄪𑄚𑄴𑄣𑄳𑄠𑄚𑄳𑄓𑄴 𑄃𑄳𑄃 𑄣𑄝𑄳𑄢𑄓𑄮𑄢𑄴',
    ...
    'kk': 'Ньюфаундленд және Лабрадор',
    'ml': 'ന്യൂഫൗണ്ടൻലാൻഡ് ആന്റ് ലാബ്രഡോർ'
  },
  type: 'province',
);
const countrySubdivisionCANNS = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'NS',
  name: 'Nova Scotia',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.68198659999999, longitude: -63.744311),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.2277438, longitude: -59.676914),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.3918805, longitude: -66.3948186)),
  translations: {
    'en': 'Nova Scotia',
    'af': 'Nova Scotia',
    'ar': 'نوفا سكوشا',
...
const countrySubdivisionCANNT = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'NT',
  name: 'Northwest Territories',
  unofficialNames: ['NWT', 'Territoires du Nord-Ouest'],
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 64.8255441, longitude: -124.8457334),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 78.7613421, longitude: -101.999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 59.99995399999999, longitude: -136.4687053)),
  translations: {
    ...
    'kk': 'Солтүстік-Батыс территориялары',
    'ml': 'നോർത്ത്വെസ്റ്റ് ടെറിറ്ററീസ്'
  },
  type: 'territory',
);
const countrySubdivisionCANNU = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'NU',
  name: 'Nunavut',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 70.2997711, longitude: -83.1075769),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 83.0956638, longitude: -61.1794384),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.6406985, longitude: -121.0492491)),
  translations: {
    'en': 'Nunavut',
    'af': 'Nunavut',
    'ar': 'نونافوت',
...
const countrySubdivisionCANON = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'ON',
  name: 'Ontario',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 56.8565279, longitude: -74.34388229999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.68134879999999, longitude: -95.1562271)),
  translations: {
    'en': 'Ontario',
    'af': 'Ontario',
    'ar': 'أونتاريو',
...
const countrySubdivisionCANPE = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'PE',
  name: 'Prince Edward Island',
  unofficialNames: ['PEI', 'Île-du-Prince-Édouard'],
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.510712, longitude: -63.41681359999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.4416628, longitude: -61.97075460000001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.9481845, longitude: -64.5661238)),
  translations: {
    ...
    'ccp': '𑄛𑄳𑄢𑄨𑄚𑄴𑄥𑄴 𑄃𑄬𑄖𑄴𑄃𑄮𑄠𑄢𑄴𑄓𑄴 𑄃𑄨𑄌𑄴𑄣𑄳𑄠𑄚𑄳𑄓𑄴',
    ...
    'kk': 'Ханзада Эдуард Аралы',
    'ml': 'പ്രിൻസ് എഡ്വേർഡ് ദ്വീപ്',
    'so': 'Prince Edward Island'
  },
  type: 'province',
);
const countrySubdivisionCANQC = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'QC',
  name: 'Quebec',
  unofficialNames: ['PQ', 'Québec'],
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 52.9399159, longitude: -73.5491361),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 62.5830552, longitude: -57.1054859),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.9913581, longitude: -79.7623371)),
  translations: {
    'en': 'Quebec',
    'af': 'Quebec',
    'am': 'ኬበክ',
...
const countrySubdivisionCANSK = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'SK',
  name: 'Saskatchewan',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 60.000063, longitude: -101.362305),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.9988059, longitude: -110.0077549)),
  translations: {
    'en': 'Saskatchewan',
    'af': 'Saskatchewan',
    'ar': 'ساسكاتشوان',
    ...
    'no': 'Saskatchewan',
    'kk': 'Саскачеван',
    'ml': 'സസ്ക്കാറ്റ്ച്ചെവാൻ',
    'so': 'Saskatchewan'
  },
  type: 'province',
);
const countrySubdivisionCANYT = CountrySubdivision(
  alpha2: 'CA',
  alpha3: 'CAN',
  code: 'YT',
  name: 'Yukon',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 64.2823274, longitude: -135),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 69.646498, longitude: -123.8009179),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 59.996889, longitude: -141.00187)),
  translations: {
    'en': 'Yukon',
    'af': 'Yukon',
    'ar': 'يوكون',
