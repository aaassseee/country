...
const countrySubdivisionSYRDI = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'DI',
  name: 'Dimashq',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 33.513, longitude: 36.292),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 33.5651386, longitude: 36.3678997),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 33.4498124, longitude: 36.1978912)),
  translations: {
    'en': 'Damascus',
    'ar': 'محافظة دمشق',
    'be': 'Мухафаза Дамаск',
    ...
    'no': 'Damaskus',
    'cy': 'Rhaglawiaeth Damascus',
    'he': 'דמשק (מחוז)',
    'hr': 'Damask (pokrajina)',
    'ta': 'டமாஸ்கஸ் ஆளுநரகம்',
    'th': 'เขตผู้ว่าการดามัสกัส'
  },
  type: 'province',
);
const countrySubdivisionSYRDR = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'DR',
  name: 'Dar\'ā',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 32.625278, longitude: 36.106111),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 32.6466746, longitude: 36.1277676),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 32.5963599, longitude: 36.0721494)),
  translations: {
    'en': 'Daraa',
    'ar': 'محافظة درعا',
    'bg': 'Дараа',
    ...
    'hr': 'Daraa (pokrajina)',
    'ta': 'தாரா ஆளுநரகம்',
    'th': 'เขตผู้ว่าการดัรอา',
    'yue': '德拉 (省)',
    'yue_Hans': '德拉 (省)'
  },
  type: 'province',
);
const countrySubdivisionSYRDY = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'DY',
  name: 'Dayr az Zawr',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 35.336, longitude: 40.145),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.3734271, longitude: 40.1946509),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.2968173, longitude: 40.0813007)),
  translations: {
    'en': 'Deir ez-Zor',
    'ar': 'محافظة دير الزور',
    ...
    'ccp': '𑄓𑄠𑄬𑄢𑄴 𑄃𑄬𑄌𑄴-𑄎𑄮𑄢𑄴',
    'no': 'Dayr az-Zawr',
    'be': 'мухафаза Дэйр-эз-Зор',
    'yue': '代爾祖爾 (省)',
    'yue_Hans': '代尔祖尔 (省)'
  },
  type: 'province',
);
const countrySubdivisionSYRHA = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'HA',
  name: 'Al Ḩasakah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 36.405515, longitude: 40.7969149),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 37.319145, longitude: 42.3850397),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.5298381, longitude: 39.452599)),
  translations: {
    'en': 'Al-Hasakah',
    'ar': 'محافظة الحسكة',
...
const countrySubdivisionSYRHI = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'HI',
  name: 'Ḩimş',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 33.7348116, longitude: -117.9947778),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Homs',
...
const countrySubdivisionSYRHL = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'HL',
  name: 'Ḩalab',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 33.9166667, longitude: 38.3),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Aleppo',
    ...
    'no': 'Aleppo',
    'hr': 'Pokrajina Alep',
    'jv': 'Kagubernuran Aleppo',
    'ta': 'அலெப்போ ஆளுநரகம்',
    'th': 'เขตผู้ว่าการอะเลปโป',
    'yue': '阿勒頗 (省)',
    'yue_Hans': '阿勒颇 (省)'
  },
  type: 'province',
);
const countrySubdivisionSYRHM = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'HM',
  name: 'Ḩamāh',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 32.8947222, longitude: 37.12527780000001),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Hama',
...
const countrySubdivisionSYRID = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'ID',
  name: 'Idlib',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 35.933333, longitude: 36.633333),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.9471799, longitude: 36.6674555),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.90606289999999, longitude: 36.6036813)),
  translations: {
    'en': 'Idlib',
    'ar': 'محافظة إدلب',
    'az': 'İdlib mühafazası',
...
const countrySubdivisionSYRLA = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'LA',
  name: 'Al Ladhiqiyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 35.6129791, longitude: 36.0023225),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.940891, longitude: 36.2848139),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.194528, longitude: 35.7272339)),
  translations: {
    'en': 'Latakia',
    'ar': 'محافظة اللاذقية',
    ...
    'ccp': '𑄣𑄑𑄇𑄨𑄠',
    'no': 'Latakia',
    'hr': 'Latakija (pokrajina)',
    'ta': 'லடாகியா ஆளுநரகம்',
    'th': 'เขตผู้ว่าการอัลลาษิกียะฮ์',
    'yue': '拉塔基亞 (省)',
    'yue_Hans': '拉塔基亚 (省)'
  },
  type: 'province',
);
const countrySubdivisionSYRQU = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'QU',
  name: 'Al Qunaytirah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 33.0776318, longitude: 35.8934136),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 33.247301, longitude: 36.003361),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 32.836052, longitude: 35.8478781)),
  translations: {
    'en': 'Quneitra',
    'ar': 'محافظة القنيطرة',
    ...
    'no': 'Al-Qunaytirah',
    'hi': 'क़ुनेइत्राह प्रान्त',
    'hr': 'Quneitra (pokrajina)',
    'yue': '古奈特拉 (省)',
    'yue_Hans': '古奈特拉 (省)'
  },
  type: 'province',
);
const countrySubdivisionSYRRA = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'RA',
  name: 'Ar Raqqah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 35.9594106, longitude: 38.9981052),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.9821736, longitude: 39.0682411),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 35.9272857, longitude: 38.9259338)),
  translations: {
    'en': 'Ar-Raqqah',
    'ar': 'محافظة الرقة',
    ...
    'mk': 'Рака',
    'no': 'Ar-Raqqah',
    'hi': 'अर-रक़्क़ाह प्रान्त',
    'hr': 'Pokrajina Raqqa',
    'th': 'เขตผู้ว่าการอัรร็อกเกาะฮ์',
    'yue': '拉卡 (省)',
    'yue_Hans': '拉卡 (省)'
  },
  type: 'province',
);
const countrySubdivisionSYRRD = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'RD',
  name: 'Rif Dimashq',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 33.5167289, longitude: 36.954107),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 34.2120558, longitude: 38.313671),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 32.68313, longitude: 35.834707)),
  translations: {
    'en': 'Rif Dimashq',
    'ar': 'محافظة ريف دمشق',
...
const countrySubdivisionSYRSU = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'SU',
  name: 'As Suwayda\'',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 32.7, longitude: 36.566667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 32.7348733, longitude: 36.6076899),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 32.6688949, longitude: 36.5449906)),
  translations: {
    'en': 'As-Suwayda',
    'ar': 'محافظة السويداء',
...
const countrySubdivisionSYRTA = CountrySubdivision(
  alpha2: 'SY',
  alpha3: 'SYR',
  code: 'TA',
  name: 'Tartus',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 34.883333, longitude: 35.883333),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 34.9235482, longitude: 35.9136459),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 34.8481038, longitude: 35.8542896)),
  translations: {
    'en': 'Tartus',
    'ar': 'محافظة طرطوس',
    ...
    'ru': 'Тартус',
    'si': 'ටාර්ටස් පරිපාලන දිස්ත්‍රිකය',
    'sr': 'Тартус (покрајина)',
    'sv': 'Tartus',
