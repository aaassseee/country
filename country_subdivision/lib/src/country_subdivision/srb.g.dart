...
const countrySubdivisionSRB00 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '00',
  name: 'Belgrade',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.786568, longitude: 20.4489216),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.9424453, longitude: 20.6189345),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.6880454, longitude: 20.2217102)),
  translations: {
    'en': 'Beograd',
    'af': 'Belgrado',
    'am': 'በልግራድ',
...
const countrySubdivisionSRB01 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '01',
  name: 'Severna Backa',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.9803394, longitude: 19.5907),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.1912459, longitude: 19.875136),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.6242571, longitude: 19.3011208)),
  translations: {
    'en': 'North Bačka',
    ...
    'bs': 'Sjevernobački upravni okrug',
    'fa': 'ناحیه باچکای شمالی'
  },
  type: 'district',
);
const countrySubdivisionSRB02 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '02',
  name: 'Srednji Banat',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.4788485, longitude: 20.6082522),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.811237, longitude: 21.0307331),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.0783, longitude: 20.027785)),
  translations: {
    'en': 'Central Banat',
    ...
    'bs': 'Srednjobanatski upravni okrug',
    'fa': 'ناحیه بانات مرکزی'
  },
  type: 'district',
);
const countrySubdivisionSRB03 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '03',
  name: 'Severni Banat',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.906839, longitude: 19.9993417),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.178631, longitude: 20.665928),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.598248, longitude: 19.7715084)),
  translations: {
    'en': 'North Banat',
    ...
    'bs': 'Sjevernobanatski upravni okrug',
    'fa': 'ناحیه بانات شمالی'
  },
  type: 'district',
);
const countrySubdivisionSRB04 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '04',
  name: 'Južni Banat',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.0027457, longitude: 21.0542509),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.334724, longitude: 21.56465),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.65840499999999, longitude: 20.41565)),
  translations: {
    'en': 'South Banat',
    ...
    'fa': 'ناحیه بانات جنوبی'
  },
  type: 'district',
);
const countrySubdivisionSRB05 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '05',
  name: 'Zapadna Backa',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.7355385, longitude: 19.1897364),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.0410499, longitude: 19.6157879),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.436847, longitude: 18.8493741)),
  translations: {
    'en': 'West Bačka',
    ...
    'fa': 'ناحیه باچکای غربی'
  },
  type: 'district',
);
const countrySubdivisionSRB06 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '06',
  name: 'Južna Backa',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.4890344, longitude: 19.6976187),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.7750259, longitude: 20.313821),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.133575, longitude: 18.981784)),
  translations: {
    'en': 'South Bačka',
    ...
    'mn': 'Өмнө Бачка аймаг',
    'no': 'Sør Backa',
    'bs': 'Južnobački upravni okrug',
    'fa': 'ناحیه باچکای جنوبی',
    'hy': 'Հարավային Բաչկայի շրջան'
  },
  type: 'district',
);
const countrySubdivisionSRB07 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '07',
  name: 'Srem',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.0029171, longitude: 19.8013773),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.21000900000001, longitude: 20.361306),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.6294639, longitude: 18.9884937)),
  translations: {
    'en': 'Srem',
    'ar': 'مقاطعة سريم',
    'be': 'Срэмская акруга',
...
const countrySubdivisionSRB08 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '08',
  name: 'Macva',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.5925314, longitude: 19.5082246),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.94040200000001, longitude: 20.000317),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.1124741, longitude: 19.10721)),
  translations: {
    'en': 'Mačva',
    'ar': 'مقاطعة ماتشفا',
...
const countrySubdivisionSRB09 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '09',
  name: 'Kolubara',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.2674361, longitude: 19.8980841),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.2683338, longitude: 19.9014904),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.26653839999999, longitude: 19.8946778)),
  translations: {
    'en': 'Kolubara',
    'ar': 'مقاطعة كولوبارا',
...
const countrySubdivisionSRB10 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '10',
  name: 'Podunavlje',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.4729156, longitude: 20.9901426),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.7212919, longitude: 21.203335),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.208296, longitude: 20.7518259)),
  translations: {
    'en': 'Podunavlje',
    'ar': 'مقاطعة بودونافلي',
    'bg': 'Подунавски окръг',
    ...
    'bs': 'Podunavski upravni okrug',
    'cs': 'Podunajský okruh',
    'fa': 'ناحیه پودوناولیه'
  },
  type: 'district',
);
const countrySubdivisionSRB11 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '11',
  name: 'Branicevo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 44.705, longitude: 21.538333),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.7191731, longitude: 21.5884781),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.6723152, longitude: 21.5239334)),
  translations: {
    'en': 'Braničevo',
    ...
    'bs': 'Braničevski upravni okrug',
    'fa': 'ناحیه برانیچوو',
    'hy': 'Բռանիչևսկյան շրջան',
    'mk': 'Браничевски Округ'
  },
  type: 'district',
);
const countrySubdivisionSRB12 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '12',
  name: 'Šumadija',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.20506779999999, longitude: 20.7856565),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.441987, longitude: 21.159204),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.796296, longitude: 20.410712)),
  translations: {
    'en': 'Šumadija',
    'ar': 'مقاطعة شوماديا',
    'bg': 'Шумадийски окръг',
...
const countrySubdivisionSRB13 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '13',
  name: 'Pomoravlje',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.95913789999999, longitude: 21.271353),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.310024, longitude: 21.839969),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.7114669, longitude: 20.929701)),
  translations: {
    'en': 'Pomoravlje',
...
const countrySubdivisionSRB14 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '14',
  name: 'Bor',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.0698918, longitude: 22.0985086),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.1460006, longitude: 22.1439743),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.0400952, longitude: 21.9936849)),
  translations: {
    'en': 'Bor',
    'ar': 'مقاطعة بور',
    'bg': 'Борски окръг',
...
const countrySubdivisionSRB15 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '15',
  name: 'Zajecar',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.9015048, longitude: 22.2738011),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.9716926, longitude: 22.3112583),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.8638665, longitude: 22.1834563)),
  translations: {
    'en': 'Zaječar',
    'ar': 'مقاطعة زاييتشار',
    'bg': 'Зайчарски окръг',
    ...
    'mn': 'Заечар аймаг',
    'no': 'Zajecar distrikt',
    'be': 'Заечарская акруга',
    'bs': 'Zaječarski upravni okrug',
    'cs': 'Zaječarský okruh',
    'fa': 'ناحیه زایچار',
    'hu': 'Zaječar körzet',
    'hy': 'Զաեչարի օկրուգ',
...
const countrySubdivisionSRB16 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '16',
  name: 'Zlatibor',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.6554553, longitude: 19.6633226),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Zlatibor',
    ...
    'az': 'Zlatiborski dairəsi',
    'cs': 'Zlatiborský okruh',
    'fa': 'ناحیه زلاتیبور',
    'mk': 'Златиборски Округ'
  },
  type: 'district',
);
const countrySubdivisionSRB17 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '17',
  name: 'Moravica',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.5393662, longitude: 21.7117215),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.542258, longitude: 21.7134261),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.5364745, longitude: 21.7100169)),
  translations: {
    'en': 'Moravica',
    'ar': 'مقاطعة مورافيكا',
...
const countrySubdivisionSRB18 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '18',
  name: 'Raška',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.291944, longitude: 20.615556),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.3038197, longitude: 20.6399633),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.2702688, longitude: 20.5972195)),
  translations: {
    'en': 'Raška',
    'ar': 'مقاطعة راشكا',
    'be': 'Рашская акруга',
...
const countrySubdivisionSRB19 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '19',
  name: 'Rasina',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.5789182, longitude: 21.3484472),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.5934076, longitude: 21.3534361),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.5644288, longitude: 21.3434582)),
  translations: {
    'en': 'Rasina',
    'ar': 'مقاطعة راسينا',
    'be': 'Расінская акруга',
...
const countrySubdivisionSRB20 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '20',
  name: 'Nišava',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.3738902, longitude: 21.9322331),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.82438, longitude: 22.3710859),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.075654, longitude: 21.4754701)),
  translations: {
    'en': 'Nišava',
    'ar': 'مقاطعة نيشافا',
    'be': 'Нішаўская акруга',
    ...
    'uk': 'Нишавський район',
    'no': 'Nisava Distrikt',
    'bs': 'Nišavski upravni okrug',
    'fa': 'ناحیه نیشاوا',
    'mk': 'Нишавски Округ'
  },
  type: 'district',
);
const countrySubdivisionSRB21 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '21',
  name: 'Toplica',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.1906592, longitude: 21.3407762),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.4087109, longitude: 21.836189),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 42.868147, longitude: 20.9121709)),
  translations: {
    'en': 'Toplica',
    'ar': 'مقاطعة توبليكا',
    'bg': 'Топлишки окръг',
...
const countrySubdivisionSRB22 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '22',
  name: 'Pirot',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.1557012, longitude: 22.5856812),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.2034866, longitude: 22.6113225),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.1039909, longitude: 22.5426578)),
  translations: {
    'en': 'Pirot',
    'ar': 'مقاطعة بيروت',
    'bg': 'Пиротски окръг',
...
const countrySubdivisionSRB23 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '23',
  name: 'Jablanica',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.443889, longitude: 21.271389),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.47304099999999, longitude: 21.3261795),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.3905789, longitude: 21.2557983)),
  translations: {
    'en': 'Jablanica',
    'ar': 'محافظة يابلانيكا',
    ...
    'bs': 'Jablanički upravni okrug'
  },
  type: 'district',
);
const countrySubdivisionSRB24 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '24',
  name: 'Pcinja',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 42.5836362, longitude: 22.1430215),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 42.8436209, longitude: 22.5690361),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 42.2448299, longitude: 21.526959)),
  translations: {
    'en': 'Pčinja',
    'ar': 'مقاطعة باتشبنيا',
    'bg': 'Пчински окръг',
    ...
    'mk': 'Пчињски округ',
    'no': 'Pcinja distrikt',
    'bs': 'Pčinjski upravni okrug',
    'cs': 'Pčinja',
    'fa': 'ناحیه پچینیا'
  },
  type: 'district',
);
const countrySubdivisionSRB25 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '25',
  name: 'Kosovo',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.190032, longitude: 23.0063095),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 42.231503, longitude: 18.8385221)),
  translations: {
    'en': 'Kosovo',
...
const countrySubdivisionSRB26 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '26',
  name: 'Pec´',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.5725, longitude: 19.8797222),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Peć',
...
const countrySubdivisionSRB27 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '27',
  name: 'Prizren',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 43.6930556, longitude: 19.28),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Prizren',
    ...
    'ccp': '𑄛𑄳𑄢𑄭𑄌𑄴𑄢𑄬𑄚𑄴',
    'mn': 'Призрен аймаг',
    'fa': 'ناحیه پرازیرن صربستان'
  },
  type: 'district',
);
const countrySubdivisionSRB28 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '28',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.9980615, longitude: 19.8087171),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.998271, longitude: 19.815715),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.9979345, longitude: 19.8018674)),
  translations: {
    ...
    'zh': '科索夫斯卡米特罗维察州',
    'ccp': '𑄇𑄧𑄥𑄮𑄛𑄴𑄌𑄳𑄇 𑄟𑄨𑄑𑄳𑄢𑄮𑄞𑄨𑄇',
    'fr': 'Kosovska Mitrovica',
    'mn': 'Косов-Митровиц аймаг',
    'fa': 'ناحیه کوسووسکا میترویتسا صربستان'
  },
  type: 'district',
);
const countrySubdivisionSRB29 = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: '29',
  ...
  translations: {
    ...
    'zh': '科索沃-波莫拉夫列州',
    'sq': 'Anamorava',
    'ccp': '𑄇𑄧𑄥𑄮𑄞𑄮 𑄛𑄧𑄟𑄮𑄢𑄛𑄴𑄎𑄬',
    'mn': 'Косов-Поморав аймаг',
    'fa': 'ناحیه کوزوو-پوموراولیه',
    'id': 'Distrik Kosovo-Pomoravlje'
  },
  type: 'district',
);
const countrySubdivisionSRBKM = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: 'KM',
  ...
  translations: {
    ...
    'mn': 'Косов-Метох',
    'bs': 'Autonomna Pokrajina Kosovo i Metohija',
    'da': 'Autonome Provins af Kosovo og Metohija',
    'et': 'Kosovo ja Metohija autonoomne provints',
    'eu': 'Kosovo eta Metohiako Probintzia Autonomoa',
    'hr': 'Kosovo i Metohija',
    'hy': 'Կոսովո և Մեթոխիա',
    'ka': 'კოსოვოსა და მეტოხიის ავტონომიური მხარე',
    'mk': 'Косово и Метохија',
    'sv': 'Autonoma provinsen Kosovo och Metohija',
    'uz': 'Kosovo va metoxiya'
  },
  type: 'autonomous_province',
);
const countrySubdivisionSRBVO = CountrySubdivision(
  alpha2: 'RS',
  alpha3: 'SRB',
  code: 'VO',
  name: 'Војводина',
