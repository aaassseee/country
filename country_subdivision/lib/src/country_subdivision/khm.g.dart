...
const countrySubdivisionKHM1 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '1',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.6672596, longitude: 102.8975098),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.24883, longitude: 103.44429),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.343196, longitude: 102.3400039)),
  translations: {
    'en': 'Banteay Meanchey',
    ...
    'cy': 'Talaith Banteay Meanchey',
    'et': 'Bântéay Méan Cheăy provints',
    'he': 'באנטי מינצ׳י',
    'so': 'Banteay Meanchey Province'
  },
  type: 'province',
);
const countrySubdivisionKHM10 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '10',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.5759862, longitude: 106.2522143),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.7869431, longitude: 106.409197),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.332707, longitude: 105.9990121)),
  translations: {
    'en': 'Kratié',
    'ar': 'محافظة كراتي',
    'bg': 'Кратех',
...
const countrySubdivisionKHM11 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '11',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.7879427, longitude: 107.1011931),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.423394, longitude: 107.606102),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.059729, longitude: 106.3519529)),
  translations: {
    'en': 'Mondulkiri',
    ...
    'no': 'Mondulkiri',
    'cy': 'Rhanbarth Mondulkiri',
    'fa': 'استان موندولکیری',
    'so': 'Mondulkiri Province'
  },
  type: 'province',
);
const countrySubdivisionKHM12 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '12',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.5448729, longitude: 104.8921668),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.682486, longitude: 104.968803),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.428726, longitude: 104.779653)),
  translations: {
    'en': 'Phnom Penh',
    'af': 'Phnom Penh',
    'am': 'ፕኖም ፔን',
  ...
  type: 'autonomous_municipality',
);
const countrySubdivisionKHM13 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '13',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 14.0085797, longitude: 104.8454619),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.434327, longitude: 105.8868709),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.099064, longitude: 104.3539239)),
  translations: {
    'en': 'Preah Vihear',
    ...
    'no': 'Preah Vihear',
    'cy': 'Talaith Preah Vihear',
    'he': 'מחוז פראה ויהאר'
  },
  type: 'province',
);
const countrySubdivisionKHM14 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '14',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.485114, longitude: 105.328098),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Prey Veng',
    ...
    'no': 'Prey Veng',
    'cy': 'Talaith Prey Veng',
    'et': 'Prey Vêngi provints',
    'fa': 'استان شکار ونگ',
    'so': 'Prey Veng Province'
  },
  type: 'province',
);
const countrySubdivisionKHM15 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '15',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.533333, longitude: 103.916667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.5827952, longitude: 104.0180611),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.3524528, longitude: 103.7871553)),
  translations: {
    'en': 'Pursat',
    'ar': 'محافظة بورسات',
    'bg': 'Поусат',
...
const countrySubdivisionKHM16 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '16',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.8576607, longitude: 107.1011931),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.6864041, longitude: 107.6277161),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.1666069, longitude: 106.5465848)),
  translations: {
    'en': 'Ratanakiri',
    ...
    'no': 'Ratanakiri',
    'cy': 'Talaith Ratanakiri',
    'he': 'רטנאקירי',
    'so': 'Ratanakiri Province'
  },
  type: 'province',
);
const countrySubdivisionKHM17 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '17',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.3529103, longitude: 103.8594171),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Siem Reap',
    ...
    'no': 'Siem Reap',
    'be': 'Сіемрэап',
    'cy': 'Talaith Siem Reap',
    'fa': 'استان سیم ریپ',
    'so': 'Siem Reap Province'
  },
  type: 'province',
);
const countrySubdivisionKHM18 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '18',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.6253016, longitude: 103.5233963),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.7803603, longitude: 103.5925877),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.5427244, longitude: 103.1816841)),
  translations: {
    'en': 'Sihanoukville',
    'ar': 'سيهانوكفيل',
    'be': 'Горад Сіануквіль',
    ...
    'no': 'Sihanoukville',
    'ca': 'Sihanoukville',
    'cy': 'Talaith Sihanoukville'
  },
  type: 'province',
);
const countrySubdivisionKHM19 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '19',
  name: 'Stueng Traeng',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.576473, longitude: 105.9699878),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.587619, longitude: 106.6629029),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.108477, longitude: 105.521177)),
  translations: {
    'en': 'Stung Treng',
    ...
    'cy': 'Talaith Stung Treng',
    'fa': 'استان استونگ ترنگ'
  },
  type: 'province',
);
const countrySubdivisionKHM2 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '2',
  ...
  translations: {
    ...
    'be': 'Батамбанг',
    'cy': 'Rhanbarth Battambang',
    'fa': 'استان باتامبانگ',
    'he': 'באטאמבאנג',
    'hu': 'Battambang tartomány',
    'so': 'Battambang Province'
  },
  type: 'province',
);
const countrySubdivisionKHM20 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '20',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.0877866, longitude: 105.800951),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.1564031, longitude: 105.8909941),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.024966, longitude: 105.7366598)),
  translations: {
    'en': 'Svay Rieng',
    'ar': 'مقاطعة سفاي رينغ',
    'bg': 'Свай Риенг',
    ...
    'be': 'Свайрыенг',
    'cy': 'Talaith Svay Rieng',
    'fa': 'استان سوای رینگ',
    'so': 'Svay Rieng Province'
  },
  type: 'province',
);
const countrySubdivisionKHM21 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '21',
  name: 'Taakaev [Takêv]',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.9321519, longitude: 104.798771),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.3528621, longitude: 105.0994111),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.5201891, longitude: 104.4379809)),
  translations: {
    'en': 'Takéo',
    'ar': 'محافظة تاكو',
    'bg': 'Такео',
...
const countrySubdivisionKHM22 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '22',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 14.1717195, longitude: 103.6362715),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.4395071, longitude: 104.4748511),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.909678, longitude: 103.0405579)),
  translations: {
    'en': 'Oddar Meanchey',
    ...
    'no': 'Oddar Meancheay',
    'cy': 'Talaith Oddar Meanchey',
    'et': 'Ŏtdâr Méan Cheăy provints',
    'fa': 'استان اودار میانی',
    'hy': 'Օդդարմեանթեյ',
    'so': 'Oddar Meanchey Province'
  },
  type: 'province',
);
const countrySubdivisionKHM23 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '23',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.543246, longitude: 104.319142),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.5781139, longitude: 104.3620275),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.3438702, longitude: 104.2153591)),
  translations: {
    'en': 'Kep',
    'ar': 'محافظة كيب',
    'bn': 'কেপ প্রদেশ',
...
const countrySubdivisionKHM24 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '24',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.8539496, longitude: 102.6083506),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.8922183, longitude: 102.7534103),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.6638293, longitude: 102.4972057)),
  translations: {
    'en': 'Pailin',
    'ar': 'مقاطعة بايلين',
    'bn': 'পাইলিন প্রদেশ',
...
const countrySubdivisionKHM25 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '25',
  name: 'Tbong Khmum',
  ...
  translations: {
    ...
    'bn': 'তবৌং খমুম প্রদেশ',
    'ceb': 'Tboung Khmum',
    'cy': 'Talaith Tbong Khmum',
    'de': 'Tbong Khmum (Provinz)',
    'es': 'Provincia de Tboung Khmum',
    'et': 'Tbong Khmŭmi provints',
    'fa': 'استان تبونگ خموم',
    'fr': 'province de Tbong Khmum',
    'hi': 'त्बोन्ग ख्मुम प्रान्त',
    'it': 'provincia di Tbong Khmum',
    'ja': 'トボンクムン州',
    'km': 'ខេត្តត្បូងឃ្មុំ',
    'ko': '트봉크뭄주',
    'pt': 'Tbong Khmum',
    'ru': 'Тбонгхмум',
    'so': 'Tbong Khmum Province',
    'sv': 'Tboung Khmum',
    'th': 'จังหวัดตโบงฆมุม',
    'ur': 'تبونگ خموم صوبہ',
    'vi': 'Tbong Khmum'
...
const countrySubdivisionKHM3 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '3',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.0178724, longitude: 105.4737067),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.9600879, longitude: 105.4002787)),
  translations: {
    'en': 'Kampong Cham',
    ...
    'ccp': '𑄟𑄳𑄠𑄟𑄴𑄛𑄧𑄁 𑄌𑄟𑄴',
    'no': 'Kampong Cham',
    'az': 'Kamponqtyam vilayəti',
    'cy': 'Talaith Kampong Cham',
    'he': 'קמפונג צ׳אם'
  },
  type: 'province',
);
const countrySubdivisionKHM4 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '4',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 12.25, longitude: 104.666667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.3243638, longitude: 104.7148133),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.2167587, longitude: 104.6459342)),
  translations: {
    'en': 'Kampong Chhnang',
    ...
    'no': 'Kampong Chhnang',
    'cy': 'Talaith Kampong Chhnang',
    'et': 'Kâmpóng Chhnăngi provints',
    'fa': 'استان کامپونگ چوننگ',
    'gl': 'Kompung Chinang',
    'so': 'Kampong Chhnang Province'
  },
  type: 'province',
);
const countrySubdivisionKHM5 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '5',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.45311, longitude: 104.5202599),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Kampong Speu',
    ...
    'no': 'Kampong Spoe',
    'cy': 'Talaith Kampong Speu',
    'fa': 'استان کامپونگ اسپیو',
    'so': 'Kampong Speu Province'
  },
  type: 'province',
);
const countrySubdivisionKHM6 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '6',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.71197, longitude: 104.888603),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Kampong Thom',
    ...
    'no': 'Kampong Thom',
    'ca': 'Kampong Thom',
    'cy': 'Talaith Kampong Thom',
    'fa': 'استان کامپونگ توم',
    'hy': 'Կամպոնգ Թհոմ',
    'ro': 'Kampong Thom (provincie)',
    'so': 'Kampong Thom Province'
  },
  type: 'province',
);
const countrySubdivisionKHM7 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '7',
  name: 'Kampot [Kâmpôt]',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.7412089, longitude: 104.1930918),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.1730128, longitude: 104.7244262),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.9039915, longitude: 103.8328105)),
  translations: {
    'en': 'Kampot',
    'ar': 'محافظة كامبوت',
    'bg': 'Кампот',
...
const countrySubdivisionKHM8 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '8',
  name: 'Kandaal [Kândal]',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.4573319, longitude: 104.693403),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.4589902, longitude: 104.6949489),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.4568189, longitude: 104.6909094)),
  translations: {
    'en': 'Kandal',
    'ar': 'محافظة كندال',
    'bg': 'Кандал',
...
const countrySubdivisionKHM9 = CountrySubdivision(
  alpha2: 'KH',
  alpha3: 'KHM',
  code: '9',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.5762804, longitude: 103.3587288),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.1494559, longitude: 104.146877),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.287840300000001, longitude: 102.7800221)),
  translations: {
    'en': 'Koh Kong',
    'ar': 'محافظة كوه كونغ',
    'bg': 'Кох Конг',
