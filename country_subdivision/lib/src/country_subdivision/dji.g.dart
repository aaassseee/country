...
const countrySubdivisionDJIAR = CountrySubdivision(
  alpha2: 'DJ',
  alpha3: 'DJI',
  code: 'AR',
  name: 'Arta',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.5255528, longitude: 42.8479474),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.5316867, longitude: 42.8639103),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.5173265, longitude: 42.8388475)),
  translations: {
    'en': 'Arta',
    'ar': 'إقليم عرتا',
    'be': 'Рэгіён Арта',
...
const countrySubdivisionDJIAS = CountrySubdivision(
  alpha2: 'DJ',
  alpha3: 'DJI',
  code: 'AS',
  name: 'Ali Sabieh',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 11.15, longitude: 42.716667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.1627947, longitude: 42.7215384),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.136424, longitude: 42.6945505)),
  translations: {
    'en': 'Ali Sabieh',
    'ar': 'إقليم علي صبيح',
    'bg': 'Али Сабих',
...
const countrySubdivisionDJIDI = CountrySubdivision(
  alpha2: 'DJ',
  alpha3: 'DJI',
  code: 'DI',
  name: 'Dikhil',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.1054336, longitude: 42.3704744),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.1124048, longitude: 42.3815967),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.0995738, longitude: 42.362981)),
  translations: {
    'en': 'Dikhil',
    'ar': 'دخيل',
    'be': 'Рэгіён Дыхіл',
...
const countrySubdivisionDJIDJ = CountrySubdivision(
  alpha2: 'DJ',
  alpha3: 'DJI',
  code: 'DJ',
  name: 'Djibouti',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 11.588333, longitude: 43.145),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.6233909, longitude: 43.1837897),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.5259804, longitude: 43.1276753)),
  translations: {
    'en': 'Djibouti',
    'af': 'Djiboeti',
    'am': 'ጅቡቲ',
...
const countrySubdivisionDJIOB = CountrySubdivision(
  alpha2: 'DJ',
  alpha3: 'DJI',
  code: 'OB',
  name: 'Obock',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.9751386, longitude: 43.29488430000001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.9593636, longitude: 43.2825709)),
  translations: {
    'en': 'Obock',
    'ar': 'إقليم أوبوك',
    'be': 'Рэгіён Абок',
...
const countrySubdivisionDJITA = CountrySubdivision(
  alpha2: 'DJ',
  alpha3: 'DJI',
  code: 'TA',
  name: 'Tadjourah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.7913106, longitude: 42.87962270000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.7946021, longitude: 42.8837972),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.7876882, longitude: 42.87557109999999)),
  translations: {
    'en': 'Tadjourah',
    'ar': 'إقليم تاجورة',
    'be': 'Рэгіён Таджура',
