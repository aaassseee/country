...
const countrySubdivisionGRC69 = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: '69',
  name: 'Ágion Óros',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.2644928, longitude: 24.2152731),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.451581, longitude: 24.3991418),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.11453119999999, longitude: 23.993087)),
  translations: {
    'en': 'Mount Athos',
    'af': 'Berg Athos',
    'ar': 'جبل آثوس',
    ...
    'no': 'Athos',
    'ga': 'Sliabh Athos',
    'ky': 'Ыйык Тоо Республикасы',
    'sl': 'Atos',
    'yue': '阿索斯山',
    'yue_Hans': '阿索斯山'
  },
  type: 'self-governed_part',
);
const countrySubdivisionGRCA = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'A',
...
const countrySubdivisionGRCB = CountrySubdivision(
  ...
  translations: {
    ...
    'ccp': '𑄥𑄬𑄚𑄴𑄑𑄳𑄢𑄣𑄴 𑄟𑄥𑄬𑄓𑄮𑄚𑄨𑄠',
    'mk': 'Централна Македонија',
    'no': 'Sentral-Makedonia',
    'cy': 'Macedonia Canolog'
  },
  type: 'administrative_region',
);
const countrySubdivisionGRCC = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'C',
  ...
  translations: {
    ...
    'no': 'Vest-Makedonia',
    'hy': 'Արևմտյան Մակեդոնիա',
    'ky': 'Батыш Македония'
  },
  type: 'administrative_region',
);
const countrySubdivisionGRCD = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'D',
  name: 'Ípeiros',
...
const countrySubdivisionGRCE = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'E',
  name: 'Thessalía',
...
const countrySubdivisionGRCF = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'F',
  name: 'Ionía Nísia',
  ...
  translations: {
    ...
    'zh': '愛奧尼亞群島',
    'sq': 'Ishujt e Jonit',
    'ccp': '𑄃𑄨𑄠𑄮𑄚𑄨𑄠𑄧𑄚𑄴 𑄃𑄨𑄌𑄴𑄣𑄳𑄠𑄚𑄳𑄓𑄴𑄌𑄴',
    'ko': '이오니아 제도주',
    'ca': 'Regió de les Illes Jòniques',
    'no': 'De joniske øyer',
    'az': 'İon adaları (periferiya)',
    'eu': 'Joniako Uharteak (periferia)',
    'mk': 'Јонски Острови'
  },
  type: 'administrative_region',
);
const countrySubdivisionGRCG = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'G',
  name: 'Dytikí Elláda',
  ...
  translations: {
    ...
    'mk': 'Западна Грција',
    'no': 'Vest-Hellas',
    'az': 'Qərbi Yunanıstan periferiyası',
    'eu': 'Mendebaldeko Grezia'
  },
  type: 'administrative_region',
);
const countrySubdivisionGRCH = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'H',
  name: 'Stereá Elláda',
  ...
  translations: {
    ...
    'jv': 'Yunani Tengah',
    'sq': 'Greqia Qendrore',
    'ccp': '𑄥𑄬𑄚𑄴𑄑𑄳𑄢𑄣𑄴 𑄉𑄳𑄢𑄨𑄌𑄴',
    'mk': 'Централна Грција',
    'no': 'Sentral-Hellas',
    'az': 'Mərkəzi Yunanıstan',
    'da': 'Centralgrækenland',
    'ka': 'ცენტრალური საბერძნეთი'
  },
  type: 'administrative_region',
);
const countrySubdivisionGRCI = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'I',
  name: 'Attikí',
...
const countrySubdivisionGRCJ = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'J',
  name: 'Pelopónnisos',
  ...
  translations: {
    ...
    'az': 'Peloponnes',
    'cy': 'Peloponnesos',
    'eu': 'Peloponeso (periferia)'
  },
  type: 'administrative_region',
);
const countrySubdivisionGRCK = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'K',
  name: 'Vóreio Aigaío',
  ...
  translations: {
    ...
    'zh': '北愛琴',
    'jv': 'Aegea Lor',
    'ccp': '𑄅𑄪𑄖𑄳𑄦𑄧𑄢𑄴 𑄃𑄃𑄨𑄎𑄩𑄚𑄴',
    'mk': 'Северен Егеј',
    'no': 'Nordlige egeiske øyer',
    'az': 'Şimali Egey adaları',
    'cy': 'Gogledd Aegeaidd',
    'eu': 'Ipar Egeo',
    'sq': 'Egjeu Verior'
  },
...
const countrySubdivisionGRCL = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'L',
  name: 'Nótio Aigaío',
...
const countrySubdivisionGRCM = CountrySubdivision(
  alpha2: 'GR',
  alpha3: 'GRC',
  code: 'M',
  name: 'Kríti',
