...
const countrySubdivisionLC01 = CountrySubdivision(
  countryCode: 'LC',
  code: '01',
  name: 'Anse la Raye',
  unofficialNames: [],
...
const countrySubdivisionLC02 = CountrySubdivision(
  countryCode: 'LC',
  code: '02',
  name: 'Castries',
  unofficialNames: [],
...
const countrySubdivisionLC03 = CountrySubdivision(
  countryCode: 'LC',
  code: '03',
  name: 'Choiseul',
  unofficialNames: [],
...
const countrySubdivisionLC05 = CountrySubdivision(
  countryCode: 'LC',
  code: '05',
  name: 'Dennery',
  unofficialNames: [],
...
const countrySubdivisionLC06 = CountrySubdivision(
  countryCode: 'LC',
  code: '06',
  name: 'Gros Islet',
  unofficialNames: [],
...
const countrySubdivisionLC07 = CountrySubdivision(
  countryCode: 'LC',
  code: '07',
  name: 'Laborie',
  unofficialNames: [],
...
const countrySubdivisionLC08 = CountrySubdivision(
  countryCode: 'LC',
  code: '08',
  name: 'Micoud',
  unofficialNames: [],
...
const countrySubdivisionLC10 = CountrySubdivision(
  countryCode: 'LC',
  code: '10',
  name: 'Soufrière',
  unofficialNames: [],
...
const countrySubdivisionLC11 = CountrySubdivision(
  countryCode: 'LC',
  code: '11',
  name: 'Vieux Fort',
  unofficialNames: [],
...
const countrySubdivisionLC12 = CountrySubdivision(
  countryCode: 'LC',
  code: '12',
  name: 'Canaries',
  unofficialNames: [],
