...
const countrySubdivisionGAB1 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '1',
  name: 'Estuaire',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 0.4432864, longitude: 10.0807298),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 1.0599096, longitude: 10.971872),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -0.5730141, longitude: 9.3013537)),
  translations: {
    'en': 'Estuaire',
    'ar': 'محافظة إيستوير',
    'bg': 'Естуар',
    ...
    'cy': 'Talaith Estuaire',
    'fa': 'استان استیوایر',
    'zu': 'Estuaire Province'
  },
  type: 'province',
);
const countrySubdivisionGAB2 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '2',
  name: 'Haut-Ogooué',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -1.4762544, longitude: 13.914399),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 0.036923, longitude: 14.5016709),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -2.481633, longitude: 12.763475)),
  translations: {
    'en': 'Haut-Ogooué',
    ...
    'yue': '上奧果韋省',
    'no': 'Haut-Ogooué',
    'cy': 'Talaith Haut-Ogooué',
    'fa': 'استان هاوت اوگوئه',
    'he': 'אוט-אוגואה'
  },
  type: 'province',
);
const countrySubdivisionGAB3 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '3',
  name: 'Moyen-Ogooué',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -0.442784, longitude: 10.439656),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 0.2369339, longitude: 11.588225),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -1.247179, longitude: 9.563855)),
  translations: {
    'en': 'Moyen-Ogooué',
    ...
    'yue': '中奧果韋省',
    'no': 'Moyen-Ogooué',
    'cy': 'Talaith Moyen-Ogooué',
    'fa': 'استان مویان-اوگوئه'
  },
  type: 'province',
);
const countrySubdivisionGAB4 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '4',
  name: 'Ngounié',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -1.4930303, longitude: 10.9807003),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -0.5671499, longitude: 12.522441),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -2.804942, longitude: 9.858945)),
  translations: {
    'en': 'Ngounié',
    'ar': 'محافظة نغوني',
    'bg': 'Нгуние',
...
const countrySubdivisionGAB5 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '5',
  name: 'Nyanga',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -2.8821033, longitude: 11.1617356),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -2.2504051, longitude: 12.0684259),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -3.978805999999999, longitude: 9.953016)),
  translations: {
    'en': 'Nyanga',
    'ar': 'محافظة نيانغا',
    'bg': 'Нянга',
...
const countrySubdivisionGAB6 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '6',
  name: 'Ogooué-Ivindo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 0.8818311, longitude: 13.1740348),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 1.438241, longitude: 14.502347),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -0.7536951, longitude: 11.260839)),
  translations: {
    'en': 'Ogooué-Ivindo',
    ...
    'yue': '奧果韋-伊溫多省',
    'no': 'Ogooué-Ivindo',
    'cy': 'Talaith Ogooué-Ivindo',
    'fa': 'استان اوگوئه-ایویندو',
    'he': 'אוגואה-איווינדו'
  },
  type: 'province',
);
const countrySubdivisionGAB7 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '7',
  name: 'Ogooué-Lolo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -0.8844093, longitude: 12.4380581),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 0.2900861, longitude: 13.569687),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -1.90136, longitude: 11.497758)),
  translations: {
    'en': 'Ogooué-Lolo',
    ...
    'yue': '奧果韋-洛洛省',
    'no': 'Ogooué-Lolo',
    'cy': 'Talaith Ogooué-Lolo',
    'fa': 'استان اوگوئه-لولو',
    'he': 'אוגואה-לולו',
    'hy': 'Օգուվե-Լոլո'
  },
  type: 'province',
);
const countrySubdivisionGAB8 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '8',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -1.3465975, longitude: 9.7232673),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -0.2787572, longitude: 10.6113409),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -2.733783, longitude: 8.6990528)),
  translations: {
    'en': 'Ogooué-Maritime',
    ...
    'fa': 'استان اوگوئه-مارتینتایم'
  },
  type: 'province',
);
const countrySubdivisionGAB9 = CountrySubdivision(
  alpha2: 'GA',
  alpha3: 'GAB',
  code: '9',
  name: 'Woleu-Ntem',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 1.4892408, longitude: 11.7068294),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 2.322612, longitude: 13.306585),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 0.235217, longitude: 10.3579661)),
  translations: {
    'en': 'Woleu-Ntem',
    'ar': 'مقاطعة وليو-نتم',
    'bg': 'Вольо-Нтем',
