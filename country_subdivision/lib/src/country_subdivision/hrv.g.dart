...
const countrySubdivisionHRV01 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '01',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.8706612, longitude: 16.395491),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.0695047, longitude: 16.7137865),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.4676982, longitude: 15.3262593)),
  translations: {
    'en': 'Zagreb County',
    'ar': 'مقاطعة زغرب',
    ...
    'no': 'Zagreb',
    'az': 'Zaqreb jupaniyası',
    'cy': 'Sir Zagreb'
  },
  type: 'county',
);
const countrySubdivisionHRV02 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '02',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.10133930000001, longitude: 15.8809693),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.2800141, longitude: 16.2571245),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.9023158, longitude: 15.5954704)),
  translations: {
    'en': 'Krapina-Zagorje',
    ...
    'no': 'Krapina-Zagorje',
    'az': 'Krapina-Zaqorye jupaniyası',
    'cy': 'Sir Krapina-Zagorje',
    'ga': 'Contae Krapina-Zagorje'
  },
  type: 'county',
);
const countrySubdivisionHRV03 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '03',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.3837926, longitude: 16.5380995),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.6699168, longitude: 17.1949134),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.9959092, longitude: 15.7676525)),
  translations: {
    'en': 'Sisak-Moslavina',
    ...
    'no': 'Sisak-Moslavina',
    'az': 'Sisak-Moslavina jupaniyası',
    'cy': 'Sir Sisak-Moslavina',
    'ga': 'Contae Sisak-Moslavina'
  },
  type: 'county',
);
const countrySubdivisionHRV04 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '04',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.2389445, longitude: 15.3980067),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.7628058, longitude: 15.9247762),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.88255729999999, longitude: 14.961508)),
  translations: {
    'en': 'Karlovac',
    'ar': 'مقاطعة كارلوفاتش',
...
const countrySubdivisionHRV05 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '05',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.23174729999999, longitude: 16.3360558),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.4048343, longitude: 16.7739716),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.0103401, longitude: 15.8765333)),
  translations: {
    'en': 'Varaždin',
    'ar': 'مقاطعة فرازدين',
    ...
    'no': 'Varaždin',
    'az': 'Varajdin jupaniyası',
    'cy': 'Sir Varaždin'
  },
  type: 'county',
);
const countrySubdivisionHRV06 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '06',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.1568919, longitude: 16.8390826),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.3551961, longitude: 17.3057121),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.8802736, longitude: 16.3417055)),
  translations: {
    ...
    'si': 'කොප්රිවින්කා-ක්‍රිසේව්සි ප්‍රාන්තය',
    ...
    'ccp': '𑄇𑄮𑄛𑄳𑄢𑄨𑄛𑄴𑄚𑄨𑄇- 𑄇𑄳𑄢𑄨𑄎𑄬𑄛𑄴𑄥𑄭',
    'bs': 'Koprivničko-križevačka županija',
    'mk': 'Копривничко-крижевачка жупанија',
    'no': 'Koprivnica-Križevci',
    'az': 'Koprivniça-Krijevçi jupaniyası',
    'fi': 'Koprivnica-Križevci',
    'ga': 'Contae Koprivnica-Križevci'
  },
  type: 'county',
);
const countrySubdivisionHRV07 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '07',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.7809992, longitude: 16.9936575),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.088761, longitude: 17.4986747),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.4661945, longitude: 16.4888635)),
  translations: {
    ...
    'si': 'බ්ජෙලොවාර්-බිලොගොරා ප්‍රාන්තය',
    ...
    'az': 'Byelovar-Biloqora jupaniyası',
    'cy': 'Sir Bjelovar-Bilogora',
    'ga': 'Contae Bjelovar-Bilogora'
  },
  type: 'county',
);
const countrySubdivisionHRV08 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '08',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.31739959999999, longitude: 14.8167466),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.67344840000001, longitude: 15.2352703),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.4406968, longitude: 14.1078905)),
  translations: {
    ...
    'si': 'ප්‍රිමොර්ජේ-ගොර්ස්කි කොටාර් ප්‍රාන්තය',
    ...
    'ccp': '𑄛𑄳𑄢𑄭𑄟𑄮𑄢𑄴𑄎𑄬-𑄉𑄮𑄢𑄴𑄇𑄨 𑄇𑄮𑄑𑄢𑄴',
    'bs': 'Primorsko-goranska županija',
    'mk': 'Приморско-горска жупанија',
    'no': 'Primorje-Gorski Kotar',
    'az': 'Primorye-Qorski jupaniyası',
    'cy': 'Sir Primorje-Gorski Kotar',
    'ga': 'Contae Primorje-Gorski Kotar'
  },
  type: 'county',
);
const countrySubdivisionHRV09 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '09',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.6192218, longitude: 15.4701608),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.1228954, longitude: 16.1408169),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.2712303, longitude: 14.6828545)),
  translations: {
    'en': 'Lika-Senj',
    'ar': 'مقاطعة ليكا سني',
    ...
    'no': 'Lika-Senj',
    'az': 'Lika-Sen jupaniyası',
    'be': 'Ліцка-Сеньская жупанія',
    'cy': 'Sir Lika-Senj',
    'ga': 'Contae Lika-Senj'
  },
  type: 'county',
);
const countrySubdivisionHRV10 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '10',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.6557985, longitude: 17.7932472),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.99621200000001, longitude: 18.0678268),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.4725689, longitude: 17.1197372)),
  translations: {
    ...
    'si': 'විරෝවිටිකා -පොද්‍රවිනා ප්‍රාන්තය',
    ...
    'ccp': '𑄞𑄭𑄢𑄮𑄞𑄨𑄑𑄨𑄇-𑄛𑄧𑄓𑄳𑄢𑄞𑄨𑄚',
    'bs': 'Virovitičko-podravska županija',
    'mk': 'Вировитичко-подравска жупанија',
    'no': 'Virovitica-Podravina',
    'az': 'Virovitiça-Podravina jupaniyası',
    'cy': 'Sir Virovitica-Podravina',
    'ga': 'Contae Virovitica-Podravina'
  },
  type: 'county',
);
const countrySubdivisionHRV11 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '11',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.3417868, longitude: 17.8114359),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.5801629, longitude: 18.1141807),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.1823306, longitude: 16.9284931)),
  translations: {
    'en': 'Požega-Slavonia',
    ...
    'si': 'පොසේගා ස්ලැවෝනියා ප්‍රාන්තය',
    ...
    'no': 'Požega-Slavonia',
    'az': 'Pojeqa-Slavoniya jupaniyası',
    'cy': 'Sir Požega-Slavonia',
    'ga': 'Contae Požega-Slavonia'
  },
  type: 'county',
);
const countrySubdivisionHRV12 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '12',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.2637951, longitude: 17.3264562),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.39235980000001, longitude: 18.5746296),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.0434571, longitude: 17.0736625)),
  translations: {
    'en': 'Brod-Posavina',
    ...
    'no': 'Brod-Posavina',
    'az': 'Brod-Posavina jupaniyası',
    'cy': 'Sir Brod-Posavina',
    'ga': 'Contae Brod-Posavina',
    'he': 'ברוד-פוזבינה'
  },
  type: 'county',
);
const countrySubdivisionHRV13 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '13',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 44.146939, longitude: 15.6164943),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.5384474, longitude: 16.2202414),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.8228067, longitude: 14.5670193)),
  translations: {
    'en': 'Zadar',
    'ar': 'مقاطعة زادار',
...
const countrySubdivisionHRV14 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '14',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.5576428, longitude: 18.3942141),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.9217976, longitude: 19.1025689),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.2042832, longitude: 17.8840624)),
  translations: {
    'en': 'Osijek-Baranja',
    ...
    'no': 'Osijek-Baranja',
    'az': 'Osiyek-Baranya jupaniyası',
    'cy': 'Sir Osijek-Baranja',
    'ga': 'Contae Osijek-Baranja'
  },
  type: 'county',
);
const countrySubdivisionHRV15 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '15',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.9281485, longitude: 16.1037694),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.2164979, longitude: 16.5426211),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.4868297, longitude: 15.2068282)),
  translations: {
    'en': 'Šibenik-Knin',
    ...
    'no': 'Šibenik-Knin',
    'az': 'Şibenik-Knin jupaniyası',
    'cy': 'Sir Šibenik-Knin',
    'ga': 'Contae Šibenik-Knin',
    'he': 'מחוז שיבניק-קנין'
  },
  type: 'county',
);
const countrySubdivisionHRV16 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '16',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.1773552, longitude: 18.8053527),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.4856329, longitude: 19.4480523),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.8497502, longitude: 18.4948404)),
  translations: {
    'en': 'Vukovar-Syrmia',
    ...
    'no': 'Vukovar-Syrmia',
    'az': 'Vukovar-Sriyem jupaniyası',
    'cy': 'Sir Vukovar-Syrmia',
    'ga': 'Contae Vukovar-Syrmia'
  },
  type: 'county',
);
const countrySubdivisionHRV17 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '17',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.5240328, longitude: 16.8178377),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.9736159, longitude: 17.4510685),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 42.38713629999999, longitude: 15.709013)),
  translations: {
    'en': 'Split-Dalmatia',
    ...
    'si': 'ස්ප්ලිට් ඩල්මටියා ප්‍රාන්තය',
    ...
    'ccp': '𑄃𑄨𑄌𑄴𑄛𑄳𑄣𑄨𑄖𑄴-𑄓𑄣𑄴𑄟𑄑𑄨𑄠',
    'bs': 'Splitsko-dalmatinska županija',
    'mk': 'Сплитско-далматинска жупанија',
    'no': 'Split-Dalmatia',
    'az': 'Split-Dalmatiya jupaniyası',
    'cy': 'Sir Split-Dalmatia',
    'ga': 'Contae Split-Dalmatia'
  },
  type: 'county',
);
const countrySubdivisionHRV18 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '18',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.1286455, longitude: 13.901542),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.5196036, longitude: 14.2285896),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 44.75755170000001, longitude: 13.4896865)),
  translations: {
    'en': 'Istria',
    'ar': 'مقاطعة إستريا',
    ...
    'no': 'Istria',
    'az': 'İstriya jupaniyası',
    'be': 'Істрыйская жупанія',
    'cy': 'Sir Istria',
    'ga': 'Contae Istria'
  },
  type: 'county',
);
const countrySubdivisionHRV19 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '19',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 43.0766588, longitude: 17.5268471),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 43.17750849999999, longitude: 18.5337474),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 42.3922402, longitude: 16.4876151)),
  translations: {
    ...
    'si': 'ඩබ්රෝව්නික් නෙරෙට්වා ප්‍රාන්තය',
    ...
    'ccp': '𑄓𑄪𑄝𑄳𑄢𑄮𑄛𑄴𑄚𑄨𑄇𑄴-𑄚𑄬𑄢𑄬𑄖𑄴𑄞',
    'he': 'מחוז דוברובניק-נרטבה',
    'bs': 'Dubrovačko-neretvanska županija',
    'mk': 'Дубровничко-неретванска жупанија',
    'no': 'Dubrovnik-Neretva',
    'az': 'Dubrovnik-Neretva jupaniyası',
    'cy': 'Sir Dubrovnik-Neretva',
    'ga': 'Contae Dubrovnik-Neretva'
  },
  type: 'county',
);
const countrySubdivisionHRV20 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '20',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.3766644, longitude: 16.4213298),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.5552234, longitude: 16.8580089),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.2877571, longitude: 16.2384532)),
  translations: {
    'en': 'Međimurje',
    'ar': 'مقاطعة ماجيموريه',
...
const countrySubdivisionHRV21 = CountrySubdivision(
  alpha2: 'HR',
  alpha3: 'HRV',
  code: '21',
  name: 'Grad Zagreb',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.8150108, longitude: 15.981919),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.9395392, longitude: 16.1069727),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.7408527, longitude: 15.8216904)),
  translations: {
    'en': 'Zagreb',
    'af': 'Zagreb',
    'am': 'ዛግሬብ',
