...
const countrySubdivisionTJKDU = CountrySubdivision(
  alpha2: 'TJ',
  alpha3: 'TJK',
  code: 'DU',
  name: 'Dushanbe',
...
const countrySubdivisionTJKGB = CountrySubdivision(
  alpha2: 'TJ',
  alpha3: 'TJK',
  code: 'GB',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 38.412732, longitude: 73.087749),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.46881500000001, longitude: 75.1514831),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 36.671535, longitude: 70.216537)),
  translations: {
    'en': 'Gorno-Badakhshan',
    'ar': 'جورنو',
    ...
    'eu': 'Badakhxan Garaiko Probintzia Autonomoa',
    'kk': 'Тәжікстанның Таулы Бадахшан аймағы',
    'mn': 'Горно-Бадахшан',
    'ro': 'Gorno-Badahșan'
  },
  type: 'autonomous_region',
);
const countrySubdivisionTJKKT = CountrySubdivision(
  alpha2: 'TJ',
  alpha3: 'TJK',
  code: 'KT',
  name: 'Khatlon',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 37.9113562, longitude: 69.097023),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.783459, longitude: 70.34964699999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 36.9281721, longitude: 67.78614600000002)),
  translations: {
    'en': 'Khatlon',
    'ar': 'محافظة خاتلون',
    'bg': 'Хатлонска област',
...
const countrySubdivisionTJKRA = CountrySubdivision(
  alpha2: 'TJ',
  alpha3: 'TJK',
  code: 'RA',
  ...
  translations: {
    ...
    'ca': 'Districtes de la Subordinació Republicana',
    'eu': 'Errepublikarekiko mendekotasunpeko barrutiak'
  },
  type: 'districts_under_republic_administration',
);
const countrySubdivisionTJKSU = CountrySubdivision(
  alpha2: 'TJ',
  alpha3: 'TJK',
  code: 'SU',
  name: 'Sughd',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.5155326, longitude: 69.097023),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.0422438, longitude: 70.984337),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.926113, longitude: 67.3871309)),
  translations: {
    'en': 'Sughd',
    'ar': 'صغد',
    'az': 'Sogd vilayəti',
