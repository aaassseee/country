...
const countrySubdivisionPAN1 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '1',
  name: 'Bocas del Toro',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 9.340556, longitude: -82.240556),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.453332, longitude: -82.2274304),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.3292808, longitude: -82.33235839999999)),
  translations: {
    'en': 'Bocas del Toro',
    ...
    'ccp': '𑄝𑄧𑄇𑄌𑄴 𑄓𑄬𑄣𑄴 𑄑𑄮𑄢𑄮',
    'no': 'Bocas del Toro',
    'cy': 'Talaith Bocas del Toro',
    'gl': 'Provincia de Bocas del Toro'
  },
  type: 'province',
);
const countrySubdivisionPAN10 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '10',
  name: 'Panamá Oeste',
  ...
  translations: {
    ...
    'uk': 'Західна Панама',
    'bg': 'Панама Оесте',
    'ar': 'محافظة بنما الغربية',
    'ca': 'Província de Panamà Oest',
    'gl': 'Provincia de Panamá Oeste',
    'hu': 'Nyugat-Panama tartomány',
    'it': 'Provincia di Panama Ovest',
    'lt': 'Vakarų Panamos provincija',
    'th': 'จังหวัดปานามาโอเอสเต'
  },
  type: 'province',
);
const countrySubdivisionPAN2 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '2',
  name: 'Coclé',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 8.400144899999999, longitude: -80.42152460000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.4878652, longitude: -80.3550767),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.3281104, longitude: -80.482192)),
  translations: {
    'en': 'Coclé',
    'ar': 'مقاطعة كوكلتي',
    'bg': 'Кокле',
    ...
    'be': 'Какле',
    'cy': 'Talaith Coclé',
    'gl': 'Provincia de Coclé'
  },
  type: 'province',
);
const countrySubdivisionPAN3 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '3',
  name: 'Colón',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 9.333333, longitude: -79.89999999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.4046939, longitude: -79.83102629999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.242330299999999, longitude: -80.04467009999999)),
  translations: {
    'en': 'Colón',
    'ar': 'مقاطعة كولون',
    'bg': 'Колон',
    ...
    'cy': 'Talaith Colón',
    'fa': 'استان کلون',
    'gl': 'Provincia de Colón'
  },
  type: 'province',
);
const countrySubdivisionPAN4 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '4',
  name: 'Chiriquí',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 8.3866964, longitude: -82.2800546),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.4415651, longitude: -82.2074748),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.2904865, longitude: -82.3967314)),
  translations: {
    'en': 'Chiriquí',
    'ar': 'مقاطعة تشيريكي',
    'bg': 'Чирики',
    ...
    'no': 'Chiriqui Prrvins',
    'cy': 'Talaith Chiriquí',
    'gl': 'Provincia de Chiriquí',
    'hy': 'Չիրիկի'
  },
  type: 'province',
);
const countrySubdivisionPAN5 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '5',
  name: 'Darién',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 7.868171299999999, longitude: -77.8367282),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.9348909, longitude: -77.17411),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.221865600000001, longitude: -78.511646)),
  translations: {
    'en': 'Darién',
    'ar': 'محافظة داريان',
    'bg': 'Дариен',
    ...
    'no': 'Darien provins',
    'cy': 'Talaith Darién',
    'gl': 'Provincia de Darién'
  },
  type: 'province',
);
const countrySubdivisionPAN6 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '6',
  name: 'Herrera',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 7.7704282, longitude: -80.7214417),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.131537, longitude: -80.3965529),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.513487, longitude: -80.96242)),
  translations: {
    'en': 'Herrera',
    'ar': 'محافظة هيريرا',
    'bg': 'Ерера',
...
const countrySubdivisionPAN7 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '7',
  name: 'Los Santos',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 7.5909302, longitude: -80.365865),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.000313, longitude: -79.9944531),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.2297201, longitude: -80.734346)),
  translations: {
    'en': 'Los Santos',
    ...
    'cy': 'Talaith Los Santos'
  },
  type: 'province',
);
const countrySubdivisionPAN8 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '8',
  name: 'Panamá',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 8.983333, longitude: -79.516667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.2596966, longitude: -79.3068941),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.906754, longitude: -79.5978646)),
  translations: {
    'en': 'Panamá',
    'bg': 'Панама',
...
const countrySubdivisionPAN9 = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: '9',
  name: 'Veraguas',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 8.866667, longitude: -80.89999999999999),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Veraguas',
    ...
    'no': 'Veraguas provins',
    'cy': 'Talaith Veraguas',
    'gl': 'Provincia de Veraguas'
  },
  type: 'province',
);
const countrySubdivisionPANEM = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: 'EM',
  name: 'Emberá-Wounaan',
  ...
  type: 'indigenous_region',
);
const countrySubdivisionPANKY = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: 'KY',
  name: 'Guna Yala',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.6477792, longitude: -77.15848799999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.203556400000001, longitude: -83.05224109999999)),
  translations: {
    'ar': 'غونا يالا',
    'bg': 'Куна Яла',
    'bn': 'গুনা ইয়ালা',
    ...
    'eu': 'Guna Yala',
    'no': 'Kuna Yala',
    'gl': 'Comarca Guna Yala'
  },
  type: 'indigenous_region',
);
const countrySubdivisionPANNB = CountrySubdivision(
  alpha2: 'PA',
  alpha3: 'PAN',
  code: 'NB',
  name: 'Ngäbe-Buglé',
