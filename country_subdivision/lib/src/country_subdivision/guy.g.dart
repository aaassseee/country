...
const countrySubdivisionGUYBA = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'BA',
  name: 'Barima-Waini',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 7.488241899999999, longitude: -59.6564494),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.5480995, longitude: -58.8041041),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.981004, longitude: -60.7125971)),
  translations: {
    'en': 'Barima-Waini',
    'ar': 'باريما - ويني',
    'bg': 'Барима-Уейни',
...
const countrySubdivisionGUYCU = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'CU',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.4642141, longitude: -60.21107519999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.233457, longitude: -58.56568799999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.16021, longitude: -61.396271)),
  translations: {
    'en': 'Cuyuni-Mazaruni',
    'ar': 'كويوني مازاروني',
    'bg': 'Каюни-Мазаруни',
...
const countrySubdivisionGUYDE = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'DE',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.546425999999999, longitude: -58.0982046),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.826398299999999, longitude: -57.8823981),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.096394, longitude: -58.3052001)),
  translations: {
    'en': 'Demerara-Mahaica',
    'ar': 'ديميرارا-مهايكا',
    'bg': 'Демерара-Махайка',
...
const countrySubdivisionGUYEB = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'EB',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 2.7477922, longitude: -57.4627259),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.3251509, longitude: -56.48025089999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 1.452054, longitude: -58.518758)),
  translations: {
    ...
    'ccp': '𑄛𑄪𑄇𑄴 𑄝𑄢𑄴𑄝𑄭𑄌𑄴-𑄇𑄮𑄢𑄬𑄚𑄴𑄑𑄭𑄚𑄴',
    'no': 'East Berbice-Corentyne',
    'kk': 'Шығыс Бербис - Корентайн',
    'ro': 'East Berbice-Corentyne'
  },
  type: 'region',
);
const countrySubdivisionGUYES = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'ES',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.5720132, longitude: -58.4629997),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.0862864, longitude: -58.1656161),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.114976, longitude: -58.835067)),
  translations: {
    ...
    'kk': 'Эссекибо аралдары - Батыс Демерара',
    'ro': 'Essequibo Islands-West Demerara'
  },
  type: 'region',
);
const countrySubdivisionGUYMA = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'MA',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.238496, longitude: -57.9162555),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.7012129, longitude: -57.530811),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.8556228, longitude: -58.1318211)),
  translations: {
    'en': 'Mahaica-Berbice',
    'bg': 'Махайка-Бърбайс',
    'de': 'Mahaica-Berbice',
...
const countrySubdivisionGUYPM = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'PM',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 7.1294166, longitude: -58.9206295),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.6828597, longitude: -58.47301489999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.7601081, longitude: -59.17710700000001)),
  translations: {
    ...
    'kk': 'Померун-Супенаам',
    'ro': 'Pomeroon-Supenaam'
  },
  type: 'region',
);
const countrySubdivisionGUYPT = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'PT',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 4.7855853, longitude: -59.28799770000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.733892000000001, longitude: -58.272824),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 3.989301, longitude: -60.16331909999999)),
  translations: {
    'en': 'Potaro-Siparuni',
    'ar': 'بوتارو-سيباروني',
    'bg': 'Потаро-Сипаруни',
...
const countrySubdivisionGUYUD = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'UD',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 5.3064879, longitude: -58.18929209999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.508296100000001, longitude: -57.63137390000001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.601077, longitude: -58.8706361)),
  translations: {
    ...
    'ccp': '𑄃𑄛𑄢𑄴 𑄓𑄟𑄬𑄢𑄢-𑄝𑄢𑄴𑄝𑄭𑄌𑄴',
    'no': 'Upper Demerara-Berbice',
    'ca': 'Upper Demerara-Berbice',
    'kk': 'Жоғарғы Демерара-Бербис',
    'ro': 'Upper Demerara-Berbice'
  },
  type: 'region',
);
const countrySubdivisionGUYUT = CountrySubdivision(
  alpha2: 'GY',
  alpha3: 'GUY',
  code: 'UT',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 2.9239595, longitude: -58.73736339999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.5214021, longitude: -57.93002989999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 1.1750799, longitude: -59.992054)),
  translations: {
    ...
    'ccp': '𑄃𑄛𑄢𑄴 𑄑𑄇𑄪𑄑𑄪-𑄃𑄛𑄢𑄴 𑄃𑄨𑄥𑄬𑄇𑄭𑄪𑄝𑄮',
    'no': 'Upper Takutu-Upper Essequibo',
    'ca': 'Alt Takutu-Alto Essequibo',
    'kk': 'Жоғарғы Такуту-Жоғарғы Эссекибо',
    'ro': 'Upper Takutu-Upper Essequibo'
  },
  type: 'region',
);
