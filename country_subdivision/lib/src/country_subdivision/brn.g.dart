...
const countrySubdivisionBRNBE = CountrySubdivision(
  alpha2: 'BN',
  alpha3: 'BRN',
  code: 'BE',
  name: 'Belait',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 4.449758, longitude: 114.318703),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Belait',
...
const countrySubdivisionBRNBM = CountrySubdivision(
  alpha2: 'BN',
  alpha3: 'BRN',
  code: 'BM',
  name: 'Brunei-Muara',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 4.9311206, longitude: 114.9516869),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.045009900000001, longitude: 115.1262673),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.7286589, longitude: 114.771896)),
  translations: {
    'en': 'Brunei-Muara',
...
const countrySubdivisionBRNTE = CountrySubdivision(
  alpha2: 'BN',
  alpha3: 'BRN',
  code: 'TE',
  name: 'Temburong',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 4.6204128, longitude: 115.141484),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.9088199, longitude: 115.359444),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.296721, longitude: 115.022453)),
  translations: {
    'en': 'Temburong',
    'ar': 'مقاطعة تيمبورونغ',
    'bg': 'Тембуронг',
...
const countrySubdivisionBRNTU = CountrySubdivision(
  alpha2: 'BN',
  alpha3: 'BRN',
  code: 'TU',
  name: 'Tutong',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 4.7140373, longitude: 114.6667939),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.9333759, longitude: 114.8825069),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.3042129, longitude: 114.5288525)),
  translations: {
    'en': 'Tutong',
    'ar': 'مقاطعة توتونغ',
    'bg': 'Тутонг',
