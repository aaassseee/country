...
const countrySubdivisionZWEBU = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'BU',
  name: 'Bulawayo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -20.1325066, longitude: 28.626479),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -19.9920628, longitude: 28.7632372),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -20.2712278, longitude: 28.4270096)),
  translations: {
    'en': 'Bulawayo',
    'ru': 'Булавайо',
...
const countrySubdivisionZWEHA = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'HA',
  name: 'Harare',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -17.863889, longitude: 31.029722),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -17.6775542, longitude: 31.2246813),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -17.955721, longitude: 30.8890352)),
  translations: {
    'en': 'Harare',
    'de': 'Provinz Harare',
    'ru': 'Хараре',
...
const countrySubdivisionZWEMA = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'MA',
  name: 'Manicaland',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -18.9216386, longitude: 32.174605),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -17.250581, longitude: 33.0563049),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -21.328112, longitude: 31.23346299999999)),
  translations: {
    'en': 'Manicaland',
    'af': 'Manicaland',
...
const countrySubdivisionZWEMC = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'MC',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -16.7644295, longitude: 31.0793705),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -15.617567, longitude: 32.7613351),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -17.744136, longitude: 30.048639)),
  translations: {
...
const countrySubdivisionZWEME = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'ME',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -18.5871642, longitude: 31.2626366),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -16.6989399, longitude: 32.9946659),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -19.2712461, longitude: 30.485893)),
  translations: {
    'en': 'Mashonaland East',
    'af': 'Masjonaland-Oos',
...
const countrySubdivisionZWEMI = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'MI',
  name: 'Midlands',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -19.0552009, longitude: 29.6035495),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -17.132798, longitude: 30.8542231),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -21.045869, longitude: 27.989973)),
  translations: {
    'en': 'Midlands',
    'af': 'Midlands',
    'ar': 'محافظة ميدلاندز',
...
const countrySubdivisionZWEMN = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'MN',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -18.5331566, longitude: 27.5495846),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -17.0204861, longitude: 29.2292519),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -20.343325, longitude: 25.237028)),
  translations: {
...
const countrySubdivisionZWEMS = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'MS',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -21.052337, longitude: 29.0459927),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -19.48262, longitude: 31.1148949),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -22.351074, longitude: 26.6982439)),
  translations: {
...
const countrySubdivisionZWEMV = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'MV',
  name: 'Masvingo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -20.074444, longitude: 30.83277799999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -20.0377179, longitude: 30.86741769999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -20.1076843, longitude: 30.7932604)),
  translations: {
    'en': 'Masvingo',
    'af': 'Masvingo',
    'ar': 'منطقة ماسفينغو',
...
const countrySubdivisionZWEMW = CountrySubdivision(
  alpha2: 'ZW',
  alpha3: 'ZWE',
  code: 'MW',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -17.4851029, longitude: 29.7889248),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -15.6088341, longitude: 30.993064),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -18.902802, longitude: 28.026284)),
  translations: {
    'en': 'Mashonaland West',
    'af': 'Masjonaland-Wes',
