...
const countrySubdivisionOMNBJ = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'BJ',
...
const countrySubdivisionOMNBS = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'BS',
  ...
  translations: {
    ...
    'he': 'אל-באטנה צפון',
    'ru': 'Северная Эль-Батина²',
    'ta': 'அல் பட்டினா வடக்கு ஆளுநரகம்',
    'th': 'เขตผู้ว่าราชการอัลบาฏินะฮ์เหนือ'
  },
  type: 'governorate',
);
const countrySubdivisionOMNBU = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'BU',
  name: 'محافظة البريمي',
...
const countrySubdivisionOMNDA = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'DA',
  name: 'Ad Dakhiliyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 22.3476325, longitude: 57.2818625),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.5632319, longitude: 58.34188510000001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.904974, longitude: 56.576047)),
  translations: {
    'en': 'Ad Dakhiliyah',
    'ar': 'محافظة الداخلية',
    ...
    'ccp': '𑄃𑄖𑄴 𑄓𑄈𑄭𑄣𑄨𑄠𑄦𑄴',
    'no': 'Ad Dakhiliyah',
    'so': 'Ad Dakhiliyah Governorate'
  },
  type: 'governorate',
);
const countrySubdivisionOMNMA = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'MA',
  name: 'Masqat',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 23.61, longitude: 58.54),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.6455689, longitude: 58.6189567),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.5211218, longitude: 58.2283758)),
  translations: {
    'en': 'Muscat',
    'ar': 'محافظة مسقط',
...
const countrySubdivisionOMNMU = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'MU',
  name: 'Musandam',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 25.9942638, longitude: 56.24822769999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 26.385954, longitude: 56.5376924),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 25.2419609, longitude: 56.09789079999999)),
  translations: {
    'en': 'Musandam',
    'ar': 'محافظة مسندم',
...
const countrySubdivisionOMNSJ = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'SJ',
  ...
  translations: {
    ...
    'zh': '東南省',
    'ccp': '𑄎𑄚𑄪𑄛𑄴 𑄃𑄌𑄴 𑄥𑄧𑄢𑄴𑄇𑄪𑄃𑄨𑄦𑄴',
    'eu': 'Hego Ash Sharqiyah',
    'uk': 'Південна Еш-Шаркія',
    'no': 'Sør-Ash Sharqiyah',
    'ca': 'Governació d’Ash Sharqiyah Sud'
  },
  type: 'governorate',
);
const countrySubdivisionOMNSS = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'SS',
...
const countrySubdivisionOMNWU = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'WU',
  name: 'Al Wustá',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 20.1738655, longitude: 56.56164700000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.420908, longitude: 58.3227421),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 17.9456731, longitude: 54.9999999)),
  translations: {
    'en': 'Al Wusta',
    'ar': 'محافظة الوسطى',
...
const countrySubdivisionOMNZA = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'ZA',
  name: 'Adh Dhahirah',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 24.019926, longitude: 57.116874),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.2735939, longitude: 55.2069211)),
  translations: {
    'en': 'Ad Dhahirah',
    'ar': 'محافظة الظاهرة',
...
const countrySubdivisionOMNZU = CountrySubdivision(
  alpha2: 'OM',
  alpha3: 'OMN',
  code: 'ZU',
  name: 'محافظة ظفار',
