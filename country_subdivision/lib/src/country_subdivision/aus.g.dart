...
const countrySubdivisionAUSACT = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'ACT',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -35.4734679, longitude: 149.0123679),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -35.1245128, longitude: 149.3992848),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -35.9205307, longitude: 148.7640971)),
  translations: {
    ...
    'si': 'ඕස්ට්‍රේලියානු ප්‍රධාන කලාපය',
    ...
    'tk': 'Awstraliýanyň paýtagt territoriýasy',
    ...
    'yue_Hans': '澳洲首都地区',
    'ccp': '𑄃𑄧𑄌𑄴𑄑𑄳𑄢𑄬𑄣𑄨𑄠𑄚𑄴 𑄇𑄳𑄠𑄛𑄨𑄑𑄣𑄴 𑄑𑄬𑄢𑄨𑄑𑄮𑄢𑄨',
    ...
    'ps': 'د اسټرالیا مرکزي سیمه',
    'sd': 'آسٽريليا راڄڌاني علائقو',
    'sq': 'Territori i Kryeqytetit Australian'
  },
  type: 'territory',
);
const countrySubdivisionAUSNSW = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'NSW',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -33.864174, longitude: 151.2052868),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -28.156192, longitude: 153.6535617),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -37.5052772, longitude: 140.9992123)),
  translations: {
    'en': 'New South Wales',
    'af': 'Nieu-Suid-Wallis',
    'ar': 'نيوساوث ويلز',
    ...
    'mk': 'Нов Јужен Велс',
    'no': 'New South Wales',
    'my': 'နယူးဆောက်ဝေးပြည်နယ်',
    'ps': 'نیو ساوټ ولز',
    'sd': 'نيو سائوٿ ويلز'
  },
  type: 'state',
);
const countrySubdivisionAUSNT = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'NT',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -19.4914108, longitude: 132.5509603),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -10.9055196, longitude: 137.9990092),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -26.0168698, longitude: 129.0004244)),
  translations: {
    ...
    'no': 'Nordterritoriet',
    'ml': 'നോർത്തേൺ ടെറിട്ടറി',
    'ps': 'د اسټرالیا شمالي سیمه',
    'sd': 'نادرن خطو'
  },
  type: 'territory',
);
const countrySubdivisionAUSQLD = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'QLD',
  name: 'Queensland',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -20.9175738, longitude: 142.7027956),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -9.92973, longitude: 153.5529199),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -29.1785876, longitude: 137.9945748)),
  translations: {
    'en': 'Queensland',
    'af': 'Queensland',
    'ar': 'كوينزلاند',
...
const countrySubdivisionAUSSA = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'SA',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -30.0002315, longitude: 136.2091547),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.996392, longitude: 141.0028804),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -38.06121, longitude: 129.0005162)),
  translations: {
    'en': 'South Australia',
    'af': 'Suid-Australië',
    'ar': 'جنوب أستراليا',
    ...
    'mk': 'Јужна Австралија',
    'no': 'Sør-Australia',
    'ml': 'സൗത്ത് ഓസ്ട്രേലിയ',
    'my': 'တောင်ဩစတြေးလီးယားပြည်နယ်',
    'ps': 'سویلي اسټرالیا آیالات',
    'sd': 'ڏکڻ آسٽريليا',
    'uz': 'Janubiy avstraliya'
  },
  type: 'state',
);
const countrySubdivisionAUSTAS = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'TAS',
  name: 'Tasmania',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -41.3650419, longitude: 146.6284905),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -39.4380355, longitude: 148.7283943),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -43.8077261, longitude: 143.8182852)),
  translations: {
    'en': 'Tasmania',
    'af': 'Tasmanië',
    'ar': 'تسمانيا',
    ...
    'mk': 'Тасманија',
    'no': 'Tasmania',
    'my': 'တက်စမေးနီးယားကျွန်း',
    'ps': 'تاسماني',
    'sd': 'تسمانيا'
  },
  type: 'state',
);
const countrySubdivisionAUSVIC = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'VIC',
  name: 'Victoria',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -37.4713077, longitude: 144.7851531),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -33.9810507, longitude: 149.9764882),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -39.2247306, longitude: 140.9624773)),
  translations: {
    'en': 'Victoria',
    'af': 'Victoria',
    'ar': 'ولاية فيكتوريا',
...
const countrySubdivisionAUSWA = CountrySubdivision(
  alpha2: 'AU',
  alpha3: 'AUS',
  code: 'WA',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -27.6728168, longitude: 121.6283098),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -13.6894901, longitude: 129.0025979),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -35.1939944, longitude: 112.92145)),
  translations: {
    ...
    'no': 'Vest-Australia',
    'ml': 'വെസ്റ്റേൺ ഓസ്ട്രേലിയ',
    'ps': 'لویدیځه اسټرالیا',
    'sd': 'اولهائون آسٽريليا',
    'sq': 'Australia Perëndimore',
    'uz': 'Gʻarbiy avstraliya'
  },
  type: 'state',
);
