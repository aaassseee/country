...
const countrySubdivisionNICAN = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'AN',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.8394456, longitude: -83.93208059999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.0259089, longitude: -82.59207239999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.028599, longitude: -85.483689)),
  translations: {
    'en': 'Atlántico Norte',
    ...
    'ccp': '𑄃𑄖𑄴𑄣𑄚𑄴𑄑𑄨𑄇𑄮 𑄚𑄧𑄢𑄴𑄑𑄬',
    'mk': 'Северноатлантски автономен регион',
    'no': 'Región Autónoma del Atlántico Norte',
    'be': 'Аўтаномны рэгіён паўночна-карыбскага ўзбярэжжа',
    'fa': 'ناحیه خودمختار ساحل کارائیب شمالی'
  },
  type: 'autonomous_region',
);
const countrySubdivisionNICAS = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'AS',
  name: 'Atlántico Sur*',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.1918502, longitude: -84.1012861),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.277237, longitude: -82.97150719999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.0285841, longitude: -85.21458009999999)),
  translations: {
    'en': 'Atlántico Sur',
    ...
    'be': 'Аўтаномны рэгіён паўднёва-карыбскага ўзбярэжжа',
    'fa': 'ناحیه خودمختار ساحل کارائیب جنوبی'
  },
  type: 'autonomous_region',
);
const countrySubdivisionNICBO = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'BO',
  name: 'Boaco',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.492724, longitude: -85.52002399999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.7902051, longitude: -84.953434),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.0231972, longitude: -85.96309579999999)),
  translations: {
    'en': 'Boaco',
    'ar': 'إدارة بواكو',
...
const countrySubdivisionNICCA = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'CA',
  name: 'Carazo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.7274729, longitude: -86.21584969999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.933541, longitude: -86.063385),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.5150947, longitude: -86.4927755)),
  translations: {
    'en': 'Carazo',
    'ar': 'إدارة كارازو',
...
const countrySubdivisionNICCI = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'CI',
  name: 'Chinandega',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.8820062, longitude: -87.14228949999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.306297, longitude: -86.629938),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.44511, longitude: -87.6903076)),
  translations: {
    'en': 'Chinandega',
    'ar': 'إدارة تشينانديجا',
    ...
    'ccp': '𑄌𑄨𑄚𑄚𑄴𑄓𑄬𑄉',
    'no': 'Chinandega',
    'fa': 'دپارتمان چیناندگا'
  },
  type: 'department',
);
const countrySubdivisionNICCO = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'CO',
  name: 'Chontales',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.9394717, longitude: -85.1894045),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.632429, longitude: -84.56769709999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.6280457, longitude: -85.64550899999999)),
  translations: {
    'en': 'Chontales',
    'ar': 'إدارة تشونتاليس',
    ...
    'ccp': '𑄌𑄮𑄚𑄴𑄑𑄣𑄬𑄌𑄴',
    'no': 'Chontales',
    'az': 'Çontales departamenti'
  },
  type: 'department',
);
const countrySubdivisionNICES = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'ES',
  name: 'Estelí',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 13.083333, longitude: -86.35),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.1177659, longitude: -86.3384628),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.0616854, longitude: -86.3830947)),
  translations: {
    'en': 'Estelí',
    'ar': 'إدارة إستيلي',
...
const countrySubdivisionNICGR = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'GR',
  name: 'Granada',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 11.933333, longitude: -85.95),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.9492767, longitude: -85.94110979999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.9084219, longitude: -85.978489)),
  translations: {
    'en': 'Granada',
...
const countrySubdivisionNICJI = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'JI',
  name: 'Jinotega',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(latitude: 13.1, longitude: -86),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.1066716, longitude: -85.990076),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.0730035, longitude: -86.0085301)),
  translations: {
    'en': 'Jinotega',
    'ar': 'جينوتيغا',
...
const countrySubdivisionNICLE = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'LE',
  name: 'León',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.5092037, longitude: -86.6611083),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.107796, longitude: -86.245541),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.988095, longitude: -87.175883)),
  translations: {
    'en': 'León',
    'be': 'Дэпартамент Леон',
    'bg': 'Леон',
...
const countrySubdivisionNICMD = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'MD',
  name: 'Madriz',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.4726005, longitude: -86.4592091),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.6532971, longitude: -86.0422011),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.197792, longitude: -86.768272)),
  translations: {
    'en': 'Madriz',
    'ar': 'إدارة مدريز',
...
const countrySubdivisionNICMN = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'MN',
  name: 'Managua',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.136389, longitude: -86.251389),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.1724475, longitude: -86.1250878),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.0199606, longitude: -86.3918334)),
  translations: {
    'en': 'Managua',
    'ar': 'إدارة ماناغوا',
...
const countrySubdivisionNICMS = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'MS',
  name: 'Masaya',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 11.966667, longitude: -86.1),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.9975977, longitude: -86.07212059999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.9524256, longitude: -86.113329)),
  translations: {
    'en': 'Masaya',
    'ar': 'إدارة مسايا',
...
const countrySubdivisionNICMT = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'MT',
  name: 'Matagalpa',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 12.916667, longitude: -85.91666699999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.9567171, longitude: -85.8964561),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 12.9025089, longitude: -85.9465599)),
  translations: {
    'en': 'Matagalpa',
    'ar': 'إدارة ماتاغالبا',
...
const countrySubdivisionNICNS = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'NS',
  name: 'Nueva Segovia',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.7894404, longitude: -86.0121573),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.0770589, longitude: -85.72843209999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.4533359, longitude: -86.78519399999999)),
  translations: {
    'en': 'Nueva Segovia',
...
const countrySubdivisionNICRI = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'RI',
  name: 'Rivas',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 11.402349, longitude: -85.684578),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.6717179, longitude: -85.1754141),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.041925, longitude: -86.17159649999999)),
  translations: {
    'en': 'Rivas',
    'ar': 'إدارة ريفاز',
...
const countrySubdivisionNICSJ = CountrySubdivision(
  alpha2: 'NI',
  alpha3: 'NIC',
  code: 'SJ',
  name: 'Río San Juan',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.9324722, longitude: -83.69159719999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.9404334, longitude: -83.6843687),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.924511, longitude: -83.6988258)),
  translations: {
    'en': 'Río San Juan',
