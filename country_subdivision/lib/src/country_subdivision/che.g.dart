...
const countrySubdivisionCHEAG = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'AG',
  name: 'Aargau (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.3876664, longitude: 8.2554295),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.6209201, longitude: 8.455169999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.13755, longitude: 7.713470099999999)),
  translations: {
    'en': 'Aargau',
    'af': 'Kanton Aargau',
    'ar': 'كانتون أرجاو',
...
const countrySubdivisionCHEAI = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'AI',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.3161925, longitude: 9.4316573),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.43874, longitude: 9.617479999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.2339999, longitude: 9.309809999999999)),
  translations: {
    ...
    'ccp': '𑄃𑄬𑄛𑄬𑄚𑄴𑄎𑄬𑄣𑄴 𑄃𑄨𑄚𑄬𑄢𑄴𑄦𑄮𑄓𑄬𑄚𑄴',
    'kk': 'Аппенцелль-Иннерроден',
    'yue': '內阿彭策州',
    'bs': 'Appenzell Innerrhoden',
    'mk': 'Апенцел Инероден',
    'no': 'Appenzell Innerrhoden',
    'af': 'Kanton Appenzell Innerrhoden',
    'ga': 'Appenzell Innerrhoden',
    'hy': 'Ապենցել Իներռոդեն',
    'ps': 'آفنڅل یننر هودن'
  },
  type: 'canton',
);
const countrySubdivisionCHEAR = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'AR',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.366481, longitude: 9.3000916),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.4690301, longitude: 9.63088),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.24695, longitude: 9.1910399)),
  translations: {
    ...
    'ccp': '𑄃𑄬𑄛𑄬𑄚𑄴𑄎𑄬𑄣𑄴 𑄃𑄧𑄅𑄪𑄥𑄬𑄢𑄴𑄦𑄮𑄓𑄬𑄚𑄴',
    'kk': 'Аппенцелль-Ауссерроден',
    'yue': '外阿彭策州',
    'bs': 'Appenzell Ausserrhoden',
    'mk': 'Апенцел Аусероден',
    'no': 'Appenzell Ausserrhoden',
    'af': 'Kanton Appenzell Ausserrhoden',
    'ga': 'Appenzell Ausserrhoden',
    'hy': 'Ապենցել Աուսերռոդեն',
    'ps': 'آفنڅل اوزر هودن'
  },
  type: 'canton',
);
const countrySubdivisionCHEBE = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'BE',
  name: 'Bern (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.9479222, longitude: 7.444608499999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.99019, longitude: 7.495510099999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.9191499, longitude: 7.294230000000001)),
  translations: {
    'en': 'Bern',
    'ar': 'كانتون برن',
    'be': 'Кантон Берн',
...
const countrySubdivisionCHEBL = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'BL',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.44181220000001, longitude: 7.7644002),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.56441, longitude: 7.9618001),
      minCoordinate:
          CountrySubdivisionCoordinate(latitude: 47.33792, longitude: 7.32527)),
  translations: {
    'en': 'Basel-Landschaft',
    'ar': 'كانتون ريف بازل',
    ...
    'yue_Hans': '巴塞尔乡村州',
    'jv': 'Basel-Landschaft',
    'ccp': '𑄝𑄥𑄬𑄣𑄴-𑄣𑄳𑄠𑄚𑄳𑄓𑄴𑄌𑄳𑄠𑄜𑄳𑄑𑄴',
    'kk': 'Базель-Ланд',
    'yue': '巴塞爾鄉村州',
    'bs': 'Basel-provincija',
    'mk': 'Базел-краина',
    'no': 'Basel-Landschaft',
    'af': 'Kanton Basel-Land',
    'ga': 'Basel-Landschaft',
    'ps': 'بازل'
  },
  type: 'canton',
);
const countrySubdivisionCHEBS = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'BS',
  name: 'Basel-Stadt (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.5674422, longitude: 7.597550699999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.5899201, longitude: 7.634099999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.51931, longitude: 7.554819900000001)),
  translations: {
    'en': 'Basel-Stadt',
    ...
    'mk': 'Базел-град',
    'no': 'Basel-Stadt',
    'af': 'Kanton Basel-Stadt',
    'az': 'Bazel-Ştat kantonu',
    'ga': 'Basel-Stadt',
    'hy': 'Բազել Շտադտ'
  },
  type: 'canton',
);
const countrySubdivisionCHEFR = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'FR',
  name: 'Fribourg (fr)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.8016663, longitude: 7.145568300000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.82144, longitude: 7.1838299),
      minCoordinate:
          CountrySubdivisionCoordinate(latitude: 46.78489, longitude: 7.1357)),
  translations: {
    'en': 'Fribourg',
    'ar': 'كانتون فريبورغ',
    'be': 'Кантон Фрыбур',
...
const countrySubdivisionCHEGE = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'GE',
  name: 'Genève (fr)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.1983922, longitude: 6.142296099999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.232399, longitude: 6.177856999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.17766, longitude: 6.1103201)),
  translations: {
    'en': 'Geneva',
    'ar': 'كانتون جنيف',
    'be': 'Кантон Жэнева',
    ...
    'af': 'Kanton Genève',
    'az': 'Cenevrə kantonu',
    'el': 'καντόνι της Γενεύης',
    'ga': 'cantún na Ginéive'
  },
  type: 'canton',
);
const countrySubdivisionCHEGL = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'GL',
  name: 'Glarus (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.0404265, longitude: 9.0672085),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.1739299, longitude: 9.25249),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.7963601, longitude: 8.871229999999999)),
  translations: {
    'en': 'Glarus',
    'ar': 'كانتون غلاروس',
    'be': 'Кантон Гларус',
...
const countrySubdivisionCHEGR = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'GR',
  name: 'Graubünden (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.65698709999999, longitude: 9.578025700000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.06496, longitude: 10.4923401),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.1690499, longitude: 8.6509399)),
  translations: {
    'en': 'Graubünden',
    'ar': 'كانتون غراوبوندن',
    ...
    'mk': 'Граубинден',
    'no': 'Graubünden',
    'af': 'Kanton Graubünden',
    'az': 'Qraubünden kantonu',
    'ga': 'Graubünden',
    'ps': 'ګراو بوندن'
  },
  type: 'canton',
);
const countrySubdivisionCHEJU = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'JU',
  name: 'Jura (fr)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.3444474, longitude: 7.143060800000001),
      maxCoordinate:
          CountrySubdivisionCoordinate(latitude: 47.50452, longitude: 7.55821),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.15047999999999, longitude: 6.84042)),
  translations: {
    'en': 'Jura',
    'ar': 'كانتون جورا',
    'be': 'Кантон Юра',
...
const countrySubdivisionCHELU = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'LU',
  name: 'Luzern (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.0500376, longitude: 8.3089295),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.08349, longitude: 8.358139999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.02601989999999, longitude: 8.206470099999999)),
  translations: {
    'en': 'Lucerne',
    'ar': 'كانتون لوسيرن',
    'be': 'Кантон Люцэрн',
...
const countrySubdivisionCHENE = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'NE',
  name: 'Neuchâtel (fr)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.99297929999999, longitude: 6.931932499999999),
      maxCoordinate:
          CountrySubdivisionCoordinate(latitude: 47.06389, longitude: 6.99177),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.97817810000001, longitude: 6.893409999999999)),
  translations: {
    'en': 'Neuchâtel',
    'ar': 'كانتون نيوشاتل',
    'be': 'Кантон Нёўшатэль',
...
const countrySubdivisionCHENW = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'NW',
  name: 'Nidwalden (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.9267016, longitude: 8.3849982),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.0036169, longitude: 8.57489),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.77149, longitude: 8.2182101)),
  translations: {
    'en': 'Nidwalden',
    'ar': 'كانتون نيدفالدن',
...
const countrySubdivisionCHEOW = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'OW',
  name: 'Obwalden (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.877858, longitude: 8.251249),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.98021, longitude: 8.506639999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.75307, longitude: 8.042349999999999)),
  translations: {
    'en': 'Obwalden',
    'ar': 'كانتون أوبفالدن',
    'be': 'Кантон Обвальдэн',
...
const countrySubdivisionCHESG = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'SG',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.4179284, longitude: 9.3643968),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.4530299, longitude: 9.4353001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.3950999, longitude: 9.29144)),
  translations: {
    'en': 'St. Gallen',
    'ar': 'كانتون سانت غالن',
    ...
    'mk': 'Санкт Гален',
    'no': 'Sankt Gallen',
    'az': 'Sankt-Qallen (kanton)',
    'ga': 'cantún St. Gallen',
    'hy': 'Սուրբ Գալլենի կանտոն'
  },
  type: 'canton',
);
const countrySubdivisionCHESH = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'SH',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.7077664, longitude: 8.641442399999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.74462, longitude: 8.7058599),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.68589, longitude: 8.585830099999999)),
  translations: {
    'en': 'Schaffhausen',
    'ar': 'كانتون شافهوزن',
    'be': 'Кантон Шафхаўзен',
    ...
    'mk': 'Шафхаузен',
    'no': 'Schaffhausen',
    'af': 'Kanton Schaffhausen',
    'ga': 'cantún Schaffhausen',
    'hy': 'Շաֆհաուզեն կանտոն'
  },
  type: 'canton',
);
const countrySubdivisionCHESO = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'SO',
  name: 'Solothurn (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.2086574, longitude: 7.5379549),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.22025, longitude: 7.552230000000001),
      minCoordinate:
          CountrySubdivisionCoordinate(latitude: 47.19591, longitude: 7.50923)),
  translations: {
    'en': 'Solothurn',
    'ar': 'كانتون سولوتورن',
    'be': 'Кантон Залатурн',
...
const countrySubdivisionCHESZ = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'SZ',
  name: 'Schwyz (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.0198346, longitude: 8.647397699999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.06635, longitude: 8.7787901),
      minCoordinate:
          CountrySubdivisionCoordinate(latitude: 46.98516, longitude: 8.60339)),
  translations: {
    'en': 'Schwyz',
    'ar': 'كانتون شفيتس',
    'az': 'Şvis',
...
const countrySubdivisionCHETG = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'TG',
  name: 'Thurgau (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.60378559999999, longitude: 9.0557371),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.6954101, longitude: 9.4764901),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.3757001, longitude: 8.66793)),
  translations: {
    'en': 'Thurgau',
    'ar': 'كانتون تورغاو',
    'be': 'Кантон Тургау',
...
const countrySubdivisionCHETI = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'TI',
  name: 'Ticino (it)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.331734, longitude: 8.800452900000002),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.63241, longitude: 9.159730000000001),
      minCoordinate:
          CountrySubdivisionCoordinate(latitude: 45.81792, longitude: 8.38218)),
  translations: {
    'en': 'Ticino',
    'ar': 'كانتون تيسينو',
    'az': 'Ticino',
...
const countrySubdivisionCHEUR = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'UR',
  name: 'Uri (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.7738629, longitude: 8.602515300000002),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.9880412, longitude: 8.95788),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.52757, longitude: 8.397459999999999)),
  translations: {
    'en': 'Uri',
    'ar': 'كانتون أوري',
    'be': 'Кантон Уры',
...
const countrySubdivisionCHEVD = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'VD',
  name: 'Vaud (fr)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.5613135, longitude: 6.536765),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.98170229999999, longitude: 7.2492599),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.1870301, longitude: 6.06401)),
  translations: {
    'en': 'Vaud',
    'ar': 'كانتون فود',
    'be': 'Во',
...
const countrySubdivisionCHEVS = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'VS',
  name: 'Valais (fr)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.1904614, longitude: 7.5449226),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.6539699, longitude: 8.4785401),
      minCoordinate:
          CountrySubdivisionCoordinate(latitude: 45.85827, longitude: 6.77046)),
  translations: {
    'en': 'Valais',
    'ar': 'كانتون فاليز',
    'be': 'Кантон Вале',
...
const countrySubdivisionCHEZG = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'ZG',
  name: 'Zug (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.1745887, longitude: 8.513854),
      maxCoordinate:
          CountrySubdivisionCoordinate(latitude: 47.18973, longitude: 8.55844),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.1144752, longitude: 8.4754)),
  translations: {
    'en': 'Zug',
    'ar': 'كانتون تسوغ',
    'be': 'Кантон Цуг',
...
const countrySubdivisionCHEZH = CountrySubdivision(
  alpha2: 'CH',
  alpha3: 'CHE',
  code: 'ZH',
  name: 'Zürich (de)',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.3686498, longitude: 8.539182499999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.43468, longitude: 8.6253701),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.32023, longitude: 8.448059899999999)),
  translations: {
    'en': 'Zürich',
    'ar': 'كانتون زيورخ',
    'be': 'кантон Цюрых',
