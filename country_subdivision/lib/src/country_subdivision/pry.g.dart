...
const countrySubdivisionPRY1 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '1',
  name: 'Concepción',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -22.811926, longitude: -57.10131879999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -22.082298, longitude: -56.12232599999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -23.5051209, longitude: -57.992912)),
  translations: {
    'en': 'Concepción',
    'ar': 'إدارة كونسيبسيون',
    'bg': 'Консепсион',
    ...
    'mk': 'Консепсион',
    'th': 'จังหวัดกอนเซปซิออน',
    'tr': 'Concepción ili, Paraguay'
  },
  type: 'department',
);
const countrySubdivisionPRY10 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '10',
  name: 'Alto Paraná',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -25.6075546, longitude: -54.9611836),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -24.480299, longitude: -54.3706512),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -26.257265, longitude: -55.55426809999999)),
  translations: {
    'en': 'Alto Paraná',
    'ar': 'ألتو بارانا',
    'bg': 'Горна Парана',
...
const countrySubdivisionPRY11 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '11',
  name: 'Central',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -25.5628115, longitude: -57.5079912),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.087879, longitude: -57.177471),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -26.014746, longitude: -57.81478199999999)),
  translations: {
    'en': 'Central',
    'ar': 'الإدارة المركزية',
...
const countrySubdivisionPRY12 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '12',
  name: 'Ñeembucú',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -27.0299114, longitude: -57.825395),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.762459, longitude: -57.175465),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -27.4405351, longitude: -58.663143)),
  translations: {
    'en': 'Ñeembucú',
    'ar': 'إدارة نيمبوكو',
    'bg': 'Неембуку',
    ...
    'mk': 'Њембуку',
    'no': 'Neembucu',
    'ro': 'Departamentul Ñeembucú (Paraguay)'
  },
  type: 'department',
);
const countrySubdivisionPRY13 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '13',
  name: 'Amambay',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -22.5590272, longitude: -56.0249982),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -22.0332719, longitude: -55.5044811),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -23.8353161, longitude: -56.81702989999999)),
  translations: {
    'en': 'Amambay',
    'ar': 'إدارة امامباي',
...
const countrySubdivisionPRY14 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '14',
  name: 'Canindeyú',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -24.1378735, longitude: -55.6689636),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -23.537436, longitude: -54.25935399999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -24.78257, longitude: -56.165066)),
  translations: {
    'en': 'Canindeyú',
    'ar': 'إدارة كانينديو',
    'bg': 'Каниндею',
    ...
    'mk': 'Каниндеју',
    'no': 'Canindeyu',
    'ro': 'Departamentul Canindeyú (Paraguay)'
  },
  type: 'department',
);
const countrySubdivisionPRY15 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '15',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -23.3512605, longitude: -58.73736339999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -22.041864, longitude: -57.156029),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.2822299, longitude: -60.779007)),
  translations: {
    'en': 'Presidente Hayes',
    'ar': 'بريزيدنت هايز',
    'bg': 'Пресиденте Айес',
...
const countrySubdivisionPRY16 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '16',
  name: 'Alto Paraguay',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -20.0852508, longitude: -59.4720904),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -19.294041, longitude: -57.817802),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -22.3844591, longitude: -61.909931)),
  translations: {
    'en': 'Alto Paraguay',
    ...
    'no': 'Alto Paraguai',
    'be': 'Альта-Парагвай',
    'ro': 'Departamentul Alto Paraguay (Paraguay)'
  },
  type: 'department',
);
const countrySubdivisionPRY19 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '19',
  name: 'Boquerón',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -21.7449254, longitude: -60.9540073),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -20.057264, longitude: -59.2829549),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -23.879511, longitude: -62.6470759)),
  translations: {
    'en': 'Boquerón',
    'ar': 'مقاطعة بوكويرون',
    'bg': 'Бокерон',
...
const countrySubdivisionPRY2 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '2',
  name: 'San Pedro',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -24.1948668, longitude: -56.56164700000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -23.2985459, longitude: -55.765411),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.018806, longitude: -57.50759490000001)),
  translations: {
    'en': 'San Pedro',
    'ar': 'إدارة سان بيدرو',
    'bg': 'Сан Педро',
...
const countrySubdivisionPRY3 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '3',
  name: 'Cordillera',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -25.2289491, longitude: -57.0111681),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -24.8388179, longitude: -56.5165789),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.6632018, longitude: -57.46526)),
  translations: {
    'en': 'Cordillera',
    'ar': 'كورديليرا',
    'bg': 'Кордийера',
...
const countrySubdivisionPRY4 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '4',
  name: 'Guairá',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -25.8810932, longitude: -56.2929381),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.5627229, longitude: -55.638214),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -26.1846939, longitude: -56.77882)),
  translations: {
    'en': 'Guairá',
    'ar': 'غوايرا',
    'bg': 'Гуаира',
    ...
    'mk': 'Гваира',
    'no': 'Guaira',
    'be': 'Гуайра (дэпартамент)',
    'fa': 'بخش گوآیرا'
  },
  type: 'department',
);
const countrySubdivisionPRY5 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '5',
  name: 'Caaguazú',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: -25.46, longitude: -56.02),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.4339458, longitude: -55.9810925),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.4961221, longitude: -56.0556792)),
  translations: {
    'en': 'Caaguazú',
    'ar': 'كاغوازو',
...
const countrySubdivisionPRY6 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '6',
  name: 'Caazapá',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -26.2260696, longitude: -56.0249982),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.521578, longitude: -55.24961889999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -26.794916, longitude: -56.84550489999999)),
  translations: {
    'en': 'Caazapá',
    'ar': 'كازابا',
    'bg': 'Каасапа',
    ...
    'mk': 'Казапа',
    'no': 'Caazapa',
    'be': 'Каасапа (дэпартамент)',
    'he': 'מחוז קאאספה'
  },
  type: 'department',
);
const countrySubdivisionPRY7 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '7',
  name: 'Itapúa',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -26.7923623, longitude: -55.6689636),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -26.089293, longitude: -54.6497041),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -27.6087381, longitude: -56.710255)),
  translations: {
    'en': 'Itapúa',
    'ar': 'إيتابوا',
    'bg': 'Итапуа',
...
const countrySubdivisionPRY8 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '8',
  name: 'Misiones',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -26.8433512, longitude: -57.10131879999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -26.366865, longitude: -56.6343581),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -27.604212, longitude: -57.7468951)),
  translations: {
    'en': 'Misiones',
    'ar': 'ميسيونيس',
    'bg': 'Мисионес',
...
const countrySubdivisionPRY9 = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: '9',
  name: 'Paraguarí',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: -25.633333, longitude: -57.15),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.6093911, longitude: -57.1331068),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.6367345, longitude: -57.16448310000001)),
  translations: {
    'en': 'Paraguarí',
    'bg': 'Парагуари',
...
const countrySubdivisionPRYASU = CountrySubdivision(
  alpha2: 'PY',
  alpha3: 'PRY',
  code: 'ASU',
  name: 'Asunción',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: -25.282197, longitude: -57.63509999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.2251891, longitude: -57.52467170000001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: -25.3685162, longitude: -57.67150650000001)),
  translations: {
    'en': 'Asunción',
    'af': 'Asunción',
    'am': 'አሱንሲዮን',
