...
const countrySubdivisionCUB01 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '01',
  name: 'Pinar del Río',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 22.412222, longitude: -83.671944),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.4633914, longitude: -83.6413955),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.3613422, longitude: -83.74414449999999)),
  translations: {
    'en': 'Pinar del Río',
    'af': 'Pinar del Río',
    ...
    'mk': 'Пинар дел Рио',
    'no': 'Pinar del Rio',
    'cy': 'Talaith Pinar del Río'
  },
  type: 'province',
);
const countrySubdivisionCUB03 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '03',
  name: 'La Habana',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 23.159167, longitude: -82.271056),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.1812734, longitude: -82.0911311),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.9200574, longitude: -82.5742877)),
  translations: {
    'en': 'Havana',
    'be': 'Гавана',
...
const countrySubdivisionCUB04 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '04',
  name: 'Matanzas',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 22.5767123, longitude: -81.3399414),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.2767521, longitude: -80.47074099999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.0036335, longitude: -82.16040799999999)),
  translations: {
    'en': 'Matanzas',
    'af': 'Matanzas',
    'ar': 'ماتنزاس',
    ...
    'no': 'Matanzas',
    'cy': 'Talaith Matanzas',
    'et': 'Matanzase provints'
  },
  type: 'province',
);
const countrySubdivisionCUB05 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '05',
  name: 'Villa Clara',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 22.4937204, longitude: -79.9192702),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.1555759, longitude: -79.3098399),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.92908, longitude: -80.740882)),
  translations: {
    'en': 'Villa Clara',
    'af': 'Villa Clara',
    ...
    'az': 'Vilya-Klara əyaləti'
  },
  type: 'province',
);
const countrySubdivisionCUB06 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '06',
  name: 'Cienfuegos',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 22.2379783, longitude: -80.365865),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.5832278, longitude: -80.01658789999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.817026, longitude: -80.93570679999999)),
  translations: {
    'en': 'Cienfuegos',
    'ar': 'سينفويغوس',
    ...
    'mk': 'Сиенфуегос',
    'no': 'Cienfuegos',
    'ca': 'província de Cienfuegos',
    'cy': 'Talaith Cienfuegos',
    'et': 'Cienfuegose provints'
  },
  type: 'province',
);
const countrySubdivisionCUB07 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '07',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 21.9938214, longitude: -79.4703885),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.6677195, longitude: -78.92516309999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.4506246, longitude: -80.09424299999999)),
  translations: {
    'en': 'Sancti Spíritus',
    'ar': 'سانكتي سبيريتوس',
    'bg': 'Санкти Спиритус',
    ...
    'ca': 'Sancti Spíritus',
    'cs': 'Sancti Spíritus',
    'cy': 'Talaith Sancti Spíritus',
    'et': 'Sancti Spírituse provints',
    'hy': 'Սանկտի Սպիրիտուս'
  },
  type: 'province',
);
const countrySubdivisionCUB08 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '08',
  name: 'Ciego de Ávila',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 21.9329515, longitude: -78.5660852),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.6132385, longitude: -78.067293),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.844875, longitude: -79.45208699999999)),
  translations: {
    'en': 'Ciego de Ávila',
    ...
    'ca': 'Ciego de Ávila',
    'cs': 'Ciego de Ávila',
    'cy': 'Talaith Ciego de Ávila',
    'et': 'Ciego de Ávila provints'
  },
  type: 'province',
);
const countrySubdivisionCUB09 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '09',
  name: 'Camagüey',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.4397273, longitude: -77.8250886),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.3328497, longitude: -77.9696273)),
  translations: {
    'en': 'Camagüey',
    'ar': 'كاماغوي',
    ...
    'no': 'Camagüey',
    'cy': 'Talaith Camagüey',
    'et': 'Camagüey provints'
  },
  type: 'province',
);
const countrySubdivisionCUB10 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '10',
  name: 'Las Tunas',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 21.0605162, longitude: -76.91820969999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.4577833, longitude: -76.3107757),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.5049499, longitude: -77.831835)),
  translations: {
    'en': 'Las Tunas',
    'ar': 'مقاطعة لاس توناس',
    ...
    'no': 'Las Tunas',
    'cs': 'Las Tunas',
    'cy': 'Talaith Las Tunas'
  },
  type: 'province',
);
const countrySubdivisionCUB11 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '11',
  name: 'Holguín',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 20.7837893, longitude: -75.8069082),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.2499624, longitude: -74.7155897),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.392118, longitude: -76.7217541)),
  translations: {
    'en': 'Holguín',
    'ar': 'هولغوين',
    'be': 'Альгін',
...
const countrySubdivisionCUB12 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '12',
  name: 'Granma',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 20.3844902, longitude: -76.64127119999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.7823959, longitude: -76.1810461),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 19.8280831, longitude: -77.73912)),
  translations: {
    'en': 'Granma',
    'ar': 'غرانما',
    'be': 'Правінцыя Гранма',
...
const countrySubdivisionCUB13 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '13',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 20.01693, longitude: -75.8301537),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.0909996, longitude: -75.7598926),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 19.9578529, longitude: -75.8923008)),
  translations: {
    'en': 'Santiago de Cuba',
    'ar': 'سانتياغو دي كوبا',
    'bg': 'Сантяго де Куба',
    ...
    'zh': '圣地亚哥省',
    'ccp': '𑄥𑄚𑄴𑄑𑄨𑄠𑄉𑄮 𑄓𑄬 𑄇𑄨𑄅𑄪𑄝',
    'cs': 'Santiago de Cuba',
    'mk': 'Сантјаго де Куба',
    'no': 'Santiago de Cuba',
    'cy': 'Talaith Santiago de Cuba',
    'et': 'Santiago de Cuba provints',
    'he': 'סנטיאגו דה קובה'
  },
  type: 'province',
);
const countrySubdivisionCUB14 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '14',
  name: 'Guantánamo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 20.136667, longitude: -75.213889),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.1796493, longitude: -75.1662037),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 20.1143527, longitude: -75.2367424)),
  translations: {
    'en': 'Guantánamo',
    ...
    'no': 'Guantánamo',
    'cs': 'Guantánamo',
    'cy': 'Talaith Guantánamo',
    'et': 'Guantánamo provints',
    'fi': 'Guantánamo (provinssi)',
    'th': 'จังหวัดกวนตานาโม'
  },
  type: 'province',
);
const countrySubdivisionCUB15 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '15',
  name: 'Artemisa',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 22.7522903, longitude: -82.99316069999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.068672, longitude: -82.39349399999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.4866999, longitude: -83.3889281)),
  translations: {
    'en': 'Artemisa',
    'ar': 'أرتيميسا',
    'bg': 'Артемиса',
    ...
    'cs': 'Artemisa',
    'cy': 'Talaith Artemisa',
    'gl': 'provincia de Artemisa'
  },
  type: 'province',
);
const countrySubdivisionCUB16 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '16',
  name: 'Mayabeque',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 22.8926529, longitude: -81.9534815),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 23.1876818, longitude: -81.58065789999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 22.5725, longitude: -82.45682599999999)),
  translations: {
    'en': 'Mayabeque',
    'af': 'Mayabeque',
    'ar': 'محافظة مايابيك',
    ...
    'ca': 'província de Mayabeque',
    'cs': 'Mayabeque',
    'cy': 'Talaith Mayabeque'
  },
  type: 'province',
);
const countrySubdivisionCUB99 = CountrySubdivision(
  alpha2: 'CU',
  alpha3: 'CUB',
  code: '99',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 21.6066405, longitude: -82.82097399999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.9435016, longitude: -82.54073369999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.4382502, longitude: -83.1925464)),
  translations: {
    ...
    'ccp': '𑄃𑄨𑄌𑄴𑄣 𑄓𑄬 𑄣 𑄎𑄪𑄞𑄬𑄚𑄴𑄑𑄖𑄴',
    'kk': 'Хувентуд',
    'mk': 'Исла де ла Хувентуд',
    'no': 'Isla de la Juventud',
    'ga': 'Isla de la Juventud'
  },
