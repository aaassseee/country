...
const countrySubdivisionCPVB = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'B',
  ...
  translations: {
    ...
    'ur': 'بارلاوینتو جزائر',
    'ccp': '𑄝𑄢𑄴𑄣𑄞𑄬𑄚𑄴𑄑𑄮 𑄃𑄨𑄌𑄴𑄣𑄳𑄠𑄚𑄳𑄓𑄴𑄥𑄴',
    'be': 'астравы Барлавенту',
    'no': 'Barlavento',
    'az': 'Barlaventu adaları',
    'fa': 'جزایر بارلاونتو²',
    'ha': 'Tsibirin Barlavento',
    'ha_NE': 'Tsibirin Barlavento',
    'id': 'Kepulauan Barlavento',
    'ru': 'Острова Барловенто',
    'uk': 'Барловенто (острови)'
  },
  type: 'geographical_region',
);
const countrySubdivisionCPVBR = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'BR',
  name: 'Brava',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 14.8661257, longitude: -24.7024179),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.979173, longitude: -24.640837),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.8026825, longitude: -24.7488499)),
  translations: {
    'en': 'Brava',
    'ar': 'برافا',
    'bn': 'ব্রাভা',
...
const countrySubdivisionCPVBV = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'BV',
  name: 'Boa Vista',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 16.1372504, longitude: -22.858217),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.2250611, longitude: -22.6695356),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.9687814, longitude: -22.9649422)),
  translations: {
    'en': 'Boa Vista',
    'ar': 'بوا فيستا',
    'bn': 'বুয়ো ভিস্তা',
    ...
    'uk': 'Боа-Вішта',
    'no': 'Boa Vista',
    'ceb': 'Concelho da Boa Vista'
  },
  type: 'municipality',
);
const countrySubdivisionCPVCA = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'CA',
  name: 'Santa Catarina',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 15.0992532, longitude: -23.6918783),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.199731, longitude: -23.6272161),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.9808349, longitude: -23.7812941)),
  translations: {
    'en': 'Santa Catarina',
    'ar': 'سانتا كاتارينا',
    'bg': 'Санта Катарина',
    ...
    'uk': 'Санта-Катаріна',
    'no': 'Santa Catarina',
    'fa': 'سانتا کاتارینا (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVCF = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'CF',
  ...
  translations: {
    ...
    'zh': '福戈聖卡塔琳娜縣',
    'ccp': '𑄥𑄚𑄴𑄑 𑄇𑄳𑄠𑄑𑄢𑄨𑄚 𑄓𑄮 𑄜𑄧𑄉𑄮',
    'uk': 'Санта-Катаріна-до-Фого',
    'no': 'Santa Catarina do Fogo',
    'fa': 'سانتا کاتارینا دو فگو (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVCR = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'CR',
  name: 'Santa Cruz',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 15.1027292, longitude: -23.5609459),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.1868812, longitude: -23.4919112),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.041449, longitude: -23.639359)),
  translations: {
    'en': 'Santa Cruz',
    'ar': 'سانتا كروز',
    'bg': 'Санта Круз',
    ...
    'uk': 'Санта-Круз',
    'no': 'Santa Cruz',
    'fa': 'سانتا کروز (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVCS = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'CS',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 15.1875, longitude: -23.593),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.1908814, longitude: -23.5874318),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.1799619, longitude: -23.5979247)),
  translations: {'en': 'Calheta de São Miguel', 'ja': 'カリェタ・デ・サン・ミゲル'},
  type: 'municipality',
);
const countrySubdivisionCPVMA = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'MA',
  name: 'Maio',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 15.2003098, longitude: -23.1679793),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.3377624, longitude: -23.0840044),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.118355, longitude: -23.2338931)),
  translations: {
    'en': 'Maio',
    'ca': 'Maio',
    'de': 'Maio',
...
const countrySubdivisionCPVMO = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'MO',
  name: 'Mosteiros',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 15.034, longitude: -24.325),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.0359258, longitude: -24.3187952),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.023137, longitude: -24.3313264)),
  translations: {
    'en': 'Mosteiros',
...
const countrySubdivisionCPVPA = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'PA',
  name: 'Paúl',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 17.1005359, longitude: -24.9872821),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 17.153166, longitude: -24.967329),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 17.0717081, longitude: -25.075462)),
  translations: {
    'en': 'Paul',
    'ar': 'بول',
    'bn': 'পল',
...
const countrySubdivisionCPVPN = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'PN',
  name: 'Porto Novo',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 16.9911107, longitude: -25.2363408),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 17.1292379, longitude: -24.979912),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.9104722, longitude: -25.3556249)),
  translations: {
    'en': 'Porto Novo',
    'ar': 'بورتو نوفو',
    'bn': 'পোর্টো নোভো',
    ...
    'uk': 'Порто-Ново',
    'no': 'Porto Novo',
    'fa': 'پورتو نوو (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVPR = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'PR',
  name: 'Praia',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 14.95, longitude: -23.52),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.9727297, longitude: -23.4706162),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.9001745, longitude: -23.5428429)),
  translations: {
    'en': 'Praia',
    'ar': 'برايا',
    'bg': 'Прая',
...
const countrySubdivisionCPVRB = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'RB',
  name: 'Ribeira Brava',
...
const countrySubdivisionCPVRG = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'RG',
  name: 'Ribeira Grande',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 17.1601387, longitude: -25.1177654),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 17.199805, longitude: -25.0201209),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 17.077749, longitude: -25.2308923)),
  translations: {
    'en': 'Ribeira Grande',
    'ar': 'ريبيرا غراندي',
    'bn': 'রবিরা গ্র্যান্ডে',
...
const countrySubdivisionCPVRS = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'RS',
  ...
  translations: {
    ...
    'si': 'රිබෙයිරා ග්‍රන්ඩේ ඩි සන්තියාගෝ',
    ...
    'zh': '聖地亞哥大里貝拉縣',
    'ccp': '𑄢𑄨𑄝𑄬𑄭𑄢 𑄉𑄳𑄢𑄚𑄴𑄓𑄬 𑄓𑄬 𑄥𑄚𑄴𑄑𑄨𑄠𑄉𑄮',
    'uk': 'Рібейра-Гранде-де-Сантьяго',
    'no': 'Ribeira Grande de Santiago',
    'fa': 'ریبیرا گرانده د سانتیاگو'
  },
  type: 'municipality',
);
const countrySubdivisionCPVS = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'S',
  ...
  translations: {
    ...
    'ur': 'سوتاوینتو جزائر',
    'zh': '背風群島',
    'ccp': '𑄥𑄮𑄑𑄞𑄬𑄚𑄴𑄑𑄮 𑄃𑄨𑄌𑄴𑄣𑄳𑄠𑄚𑄳𑄓𑄴𑄥𑄴',
    'be': 'астравы Сатавенту',
    'no': 'Sotavento',
    'id': 'Kepulauan Sotavento',
    'ru': 'острова Сотовенту',
    'uk': 'Сотавенто (острови)'
  },
  type: 'geographical_region',
);
const countrySubdivisionCPVSD = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SD',
  name: 'São Domingos',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 15.025, longitude: -23.5625),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.0340585, longitude: -23.552177),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.0196346, longitude: -23.5748148)),
  translations: {
    'en': 'São Domingos',
    'ar': 'ساو دومينغوس',
    'bg': 'Сао Домингос',
    ...
    'uk': 'Сан-Домінгос',
    'no': 'São Domingos',
    'fa': 'سائو دومینگوس (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVSF = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SF',
  name: 'São Filipe',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 14.895, longitude: -24.498),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.9068766, longitude: -24.4744921),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.8795941, longitude: -24.5021173)),
  translations: {
    'en': 'São Filipe',
    'ar': 'ساو فيليب',
    'bn': 'সাঁও ফিলিপ',
    ...
    'uk': 'Сан-Філіпе',
    'no': 'São Filipe',
    'fa': 'سائو فیلیپه (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVSL = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SL',
  name: 'Sal',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 16.7266152, longitude: -22.9297109),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.8537251, longitude: -22.8727016),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.5853415, longitude: -22.9942131)),
  translations: {
    'en': 'Sal',
    'ar': 'سال',
    'bn': 'সাল',
...
const countrySubdivisionCPVSM = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SM',
  name: 'São Miguel',
  ...
  translations: {
    ...
    'ccp': '𑄥𑄃𑄮 𑄟𑄭𑄉𑄪𑄠𑄬𑄣𑄴',
    'no': 'São Miguel',
    'fa': 'سائو میگوئل (دماغه سبز)',
    'id': 'São Miguel, Tanjung Verde',
    'uk': 'Сан-Мігель (Кабо-Верде)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVSN = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SN',
  name: 'São Nicolau',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 16.6048609, longitude: -24.3103718),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.6813965, longitude: -24.0076803),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.4791765, longitude: -24.4276023)),
  translations: {'en': 'São Nicolau', 'ja': 'サン・ニコラウ島'},
  type: 'municipality',
);
const countrySubdivisionCPVSO = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SO',
  ...
  translations: {
    ...
    'zh': '聖洛倫索縣',
    'ccp': '𑄥𑄃𑄮 𑄣𑄮𑄢𑄬𑄚𑄴𑄇𑄮 𑄓𑄮𑄌𑄴 𑄃𑄧𑄢𑄴𑄉𑄃𑄮𑄌𑄴',
    'uk': 'Сан-Лоренсу-душ-Оргауш',
    'no': 'São Lourenço dos Órgãos',
    'fa': 'سائو لورنچو دوس ارگیوس (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVSS = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SS',
  ...
  translations: {
    ...
    'zh': '聖薩爾瓦多蒙多縣',
    'ccp': '𑄥𑄃𑄮 𑄥𑄣𑄴𑄞𑄘𑄧𑄢𑄴 𑄓𑄮 𑄟𑄪𑄚𑄴𑄓𑄮',
    'uk': 'Сан-Сальвадор-до-Мундо',
    'no': 'São Salvador do Mundo',
    'fa': 'سائو سالوادور دو موندو (دماغه سبز)'
  },
  type: 'municipality',
);
const countrySubdivisionCPVSV = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'SV',
  name: 'São Vicente',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 16.8341271, longitude: -24.9279547),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.9222019, longitude: -24.5742091),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 16.6069539, longitude: -25.0855633)),
  translations: {
    'en': 'São Vicente',
    'ar': 'ساو فيسنتي',
    'bn': 'সাঁও ভিন্সেন্ট',
...
const countrySubdivisionCPVTA = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'TA',
  name: 'Tarrafal',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 15.278, longitude: -23.752),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.283593, longitude: -23.7384294),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 15.2685529, longitude: -23.7590069)),
  translations: {
    'en': 'Tarrafal',
    'ar': 'تارفال',
    'bg': 'Тарафал',
...
const countrySubdivisionCPVTS = CountrySubdivision(
  alpha2: 'CV',
  alpha3: 'CPV',
  code: 'TS',
