...
const countrySubdivisionSLVAH = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'AH',
  name: 'Ahuachapán',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.9259486, longitude: -89.84113819999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.9537264, longitude: -89.8150349),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.9044087, longitude: -89.8722839)),
  translations: {
    'en': 'Ahuachapán',
    'ar': 'إدارة أهواشابان',
    'bg': 'Ауачапан',
...
const countrySubdivisionSLVCA = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'CA',
  name: 'Cabañas',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.8648288, longitude: -88.7493998),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.019085, longitude: -88.49336),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.7396891, longitude: -88.9883749)),
  translations: {
    'en': 'Cabañas',
    'ar': 'إدارة كاباناس',
    'bg': 'Кабаняс',
...
const countrySubdivisionSLVCH = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'CH',
  name: 'Chalatenango',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 14.033333, longitude: -88.93333299999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.0487081, longitude: -88.88797749999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.9967041, longitude: -88.9538956)),
  translations: {
    'en': 'Chalatenango',
    'bg': 'Чалатенанго',
...
const countrySubdivisionSLVCU = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'CU',
  name: 'Cuscatlán',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.8661957, longitude: -89.0561532),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.069207, longitude: -88.86089799999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.6386259, longitude: -89.17243099999999)),
  translations: {
    'en': 'Cuscatlán',
    'ar': 'إدارة كوسكاتلان',
    'bg': 'Кускатлан',
...
const countrySubdivisionSLVLI = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'LI',
  name: 'La Libertad',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.6817661, longitude: -89.3606298),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.0608631, longitude: -89.133437),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.4242178, longitude: -89.6235825)),
  translations: {
    'en': 'La Libertad',
    'ar': 'إدارة لا ليبرتاد',
    'bg': 'Ла Либертад',
...
const countrySubdivisionSLVMO = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'MO',
  name: 'Morazán',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.7682, longitude: -88.1291387),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.951336, longitude: -87.935045),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.542379, longitude: -88.26838610000001)),
  translations: {
    'en': 'Morazán',
    'ar': 'إدارة مورازان',
    'bg': 'Морасан',
...
const countrySubdivisionSLVPA = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'PA',
  name: 'La Paz',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.495364, longitude: -88.9796776),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.662424, longitude: -88.7764349),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.2651022, longitude: -89.16793799999999)),
  translations: {
    'en': 'La Paz',
    'ar': 'إدارة لاباز',
    'bg': 'Ла Пас',
...
const countrySubdivisionSLVSA = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'SA',
  name: 'Santa Ana',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.9778279, longitude: -89.56391190000001),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 14.0113614, longitude: -89.53943249999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.9562252, longitude: -89.58621029999999)),
  translations: {
    'en': 'Santa Ana',
    'ar': 'إدارة سانتا آنا',
    'bg': 'Санта Ана',
...
const countrySubdivisionSLVSM = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'SM',
  name: 'San Miguel',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.4451041, longitude: -88.24611829999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.8935291, longitude: -88.016002),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.1693608, longitude: -88.5278369)),
  translations: {
    'en': 'San Miguel',
    'ar': 'إدارة سان ميغيل',
    'bg': 'Сан Мигел',
...
const countrySubdivisionSLVSO = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'SO',
  name: 'Sonsonate',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.682358, longitude: -89.6628111),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.898528, longitude: -89.445171),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.5195387, longitude: -89.95551770000002)),
  translations: {
    'en': 'Sonsonate',
    'ar': 'إدارة سونسونات',
    'bg': 'Сонсонате',
...
const countrySubdivisionSLVSS = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'SS',
  name: 'San Salvador',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.6929403, longitude: -89.2181911),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.7306307, longitude: -89.1630651),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.6523257, longitude: -89.2663228)),
  translations: {
    'en': 'San Salvador',
...
const countrySubdivisionSLVSV = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'SV',
  name: 'San Vicente',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.5868561, longitude: -88.7493998),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.7897911, longitude: -88.48514999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.2529737, longitude: -88.89559799999999)),
  translations: {
    'en': 'San Vicente',
...
const countrySubdivisionSLVUN = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'UN',
  name: 'La Unión',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.336944, longitude: -87.84388899999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.3553415, longitude: -87.820673),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.319889, longitude: -87.8767204)),
  translations: {
    'en': 'La Unión',
    'bg': 'Ла Унион',
...
const countrySubdivisionSLVUS = CountrySubdivision(
  alpha2: 'SV',
  alpha3: 'SLV',
  code: 'US',
  name: 'Usulután',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 13.35, longitude: -88.45),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.3537129, longitude: -88.4276677),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.3328344, longitude: -88.45788)),
  translations: {
    'en': 'Usulután',
    'ar': 'إدارة أوسولوتان',
    'bg': 'Усулутан',
