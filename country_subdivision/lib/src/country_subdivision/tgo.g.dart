...
const countrySubdivisionTGOC = CountrySubdivision(
  alpha2: 'TG',
  alpha3: 'TGO',
  code: 'C',
  name: 'Centre',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 8.6586029, longitude: 1.0586135),
      maxCoordinate:
          CountrySubdivisionCoordinate(latitude: 9.296292, longitude: 1.650187),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.9023141, longitude: 0.3816739)),
  translations: {
    'en': 'Centrale',
    'ar': 'الإقليم الأوسط',
    'bg': 'Централен регион',
...
const countrySubdivisionTGOK = CountrySubdivision(
  alpha2: 'TG',
  alpha3: 'TGO',
  code: 'K',
  name: 'Kara',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 9.548888999999999, longitude: 1.190556),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.5661352, longitude: 1.2201691),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.534310099999999, longitude: 1.1657524)),
  translations: {
    'en': 'Kara',
    'ar': 'إقليم كارا',
    'bg': 'Кара',
...
const countrySubdivisionTGOM = CountrySubdivision(
  alpha2: 'TG',
  alpha3: 'TGO',
  code: 'M',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.4913504, longitude: 1.2891036),
      maxCoordinate:
          CountrySubdivisionCoordinate(latitude: 6.918175, longitude: 1.806693),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.109153399999999, longitude: 0.717368)),
  translations: {
    'en': 'Maritime',
    'ar': 'إقليم البحرية',
...
const countrySubdivisionTGOP = CountrySubdivision(
  alpha2: 'TG',
  alpha3: 'TGO',
  code: 'P',
  name: 'Plateaux',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 7.6101378, longitude: 1.0586135),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.368130899999999, longitude: 1.677525),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.542187, longitude: 0.501813)),
  translations: {
    'en': 'Plateaux',
    'ar': 'إقليم بلاتيوكس',
    'bg': 'Плато',
...
const countrySubdivisionTGOS = CountrySubdivision(
  alpha2: 'TG',
  alpha3: 'TGO',
  code: 'S',
  name: 'Savannes',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.5291781, longitude: 0.5257822999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.138977, longitude: 0.9969091000000001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.879532, longitude: -0.1473239)),
  translations: {
    'en': 'Savanes',
    'ar': 'إقليم سافانس',
    'bg': 'Саван',
