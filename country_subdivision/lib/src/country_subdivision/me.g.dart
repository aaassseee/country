...
const countrySubdivisionME01 = CountrySubdivision(
  countryCode: 'ME',
  code: '01',
  name: 'Andrijevica',
...
const countrySubdivisionME02 = CountrySubdivision(
  countryCode: 'ME',
  code: '02',
  name: 'Bar',
  unofficialNames: ['Bar'],
...
const countrySubdivisionME03 = CountrySubdivision(
  countryCode: 'ME',
  code: '03',
  name: 'Berane',
...
const countrySubdivisionME04 = CountrySubdivision(
  countryCode: 'ME',
  code: '04',
  name: 'Bijelo Polje',
...
const countrySubdivisionME05 = CountrySubdivision(
  countryCode: 'ME',
  code: '05',
  name: 'Budva',
...
const countrySubdivisionME06 = CountrySubdivision(
  countryCode: 'ME',
  code: '06',
  name: 'Cetinje',
...
const countrySubdivisionME07 = CountrySubdivision(
  countryCode: 'ME',
  code: '07',
  name: 'Danilovgrad',
...
const countrySubdivisionME08 = CountrySubdivision(
  countryCode: 'ME',
  code: '08',
  name: 'Herceg-Novi',
...
const countrySubdivisionME09 = CountrySubdivision(
  countryCode: 'ME',
  code: '09',
  name: 'Kolašin',
...
const countrySubdivisionME10 = CountrySubdivision(
  countryCode: 'ME',
  code: '10',
  name: 'Kotor',
...
const countrySubdivisionME11 = CountrySubdivision(
  countryCode: 'ME',
  code: '11',
  name: 'Mojkovac',
...
const countrySubdivisionME12 = CountrySubdivision(
  countryCode: 'ME',
  code: '12',
  name: 'Nikšic´',
...
const countrySubdivisionME13 = CountrySubdivision(
  countryCode: 'ME',
  code: '13',
  name: 'Plav',
...
const countrySubdivisionME14 = CountrySubdivision(
  countryCode: 'ME',
  code: '14',
  name: 'Pljevlja',
...
const countrySubdivisionME15 = CountrySubdivision(
  countryCode: 'ME',
  code: '15',
  name: 'Plužine',
...
const countrySubdivisionME16 = CountrySubdivision(
  countryCode: 'ME',
  code: '16',
  name: 'Podgorica',
...
const countrySubdivisionME17 = CountrySubdivision(
  countryCode: 'ME',
  code: '17',
  name: 'Rožaje',
...
const countrySubdivisionME18 = CountrySubdivision(
  countryCode: 'ME',
  code: '18',
  name: 'Šavnik',
...
const countrySubdivisionME19 = CountrySubdivision(
  countryCode: 'ME',
  code: '19',
  name: 'Tivat',
...
const countrySubdivisionME20 = CountrySubdivision(
  countryCode: 'ME',
  code: '20',
  name: 'Ulcinj',
...
const countrySubdivisionME21 = CountrySubdivision(
  countryCode: 'ME',
  code: '21',
  name: 'Žabljak',
...
const countrySubdivisionME22 = CountrySubdivision(
  countryCode: 'ME',
  code: '22',
  name: 'Општина Гусиње',
  unofficialNames: [],
...
const countrySubdivisionME23 = CountrySubdivision(
  countryCode: 'ME',
  code: '23',
...
const countrySubdivisionME24 = CountrySubdivision(
  countryCode: 'ME',
  code: '24',
  name: 'Tuzi',
  unofficialNames: [],
