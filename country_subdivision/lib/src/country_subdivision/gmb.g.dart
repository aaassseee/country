...
const countrySubdivisionGMBB = CountrySubdivision(
  alpha2: 'GM',
  alpha3: 'GMB',
  code: 'B',
  name: 'Banjul',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.453056, longitude: -16.5775),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.4625844, longitude: -16.5703587),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.4424473, longitude: -16.5906966)),
  translations: {
    'en': 'Banjul',
    'af': 'Banjul',
    'am': 'ባንጁል',
...
const countrySubdivisionGMBL = CountrySubdivision(
  alpha2: 'GM',
  alpha3: 'GMB',
  code: 'L',
  name: 'Lower River',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.3553306, longitude: -15.92299),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.554205, longitude: -15.1831621),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.237656, longitude: -16.2310245)),
  translations: {
    ...
    'sr_Latn': 'Donja Reka',
    'zh': '下河區',
    'ccp': '𑄣𑄮𑄠𑄢𑄴 𑄢𑄨𑄞𑄢𑄴 𑄓𑄨𑄞𑄨𑄥𑄧𑄚𑄴',
    'uk': 'Округ Нижня Річка',
    'mk': 'Долна Река',
    'no': 'Lower River',
    'ca': 'Lower River',
    'fa': 'ناحیه پست رودخانه'
  },
  type: 'division',
);
const countrySubdivisionGMBM = CountrySubdivision(
  alpha2: 'GM',
  alpha3: 'GMB',
  code: 'M',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.5336211, longitude: -14.7695962),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.5551381, longitude: -14.7130108),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.5242635, longitude: -14.8049354)),
  translations: {
    ...
    'zh': '中河區',
    'ccp': '𑄥𑄬𑄚𑄴𑄑𑄳𑄢𑄣𑄴 𑄢𑄨𑄞𑄢𑄴 𑄓𑄨𑄞𑄨𑄥𑄧𑄚𑄴',
    'mk': 'Средна Река',
    'no': 'Central River',
    'fa': 'ناحیه مرکزی رودخانه'
  },
  type: 'division',
);
const countrySubdivisionGMBN = CountrySubdivision(
  alpha2: 'GM',
  alpha3: 'GMB',
  code: 'N',
  name: 'North Bank',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.5285436, longitude: -16.0169971),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.644219, longitude: -15.309071),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.3289472, longitude: -16.5492739)),
  translations: {
...
const countrySubdivisionGMBU = CountrySubdivision(
  alpha2: 'GM',
  alpha3: 'GMB',
  code: 'U',
  name: 'Upper River',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.4257366, longitude: -14.0072348),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.5734001, longitude: -13.7977931),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.2156891, longitude: -14.5469159)),
  translations: {
    ...
    'sr_Latn': 'Gornja Reka',
    'zh': '上河區',
    'ccp': '𑄃𑄛𑄢𑄴 𑄢𑄨𑄞𑄢𑄴 𑄓𑄨𑄞𑄨𑄥𑄧𑄚𑄴',
    'mk': 'Горна Река',
    'no': 'Upper River',
    'ca': 'Upper River',
    'fa': 'ناحیه بالای رودخانه'
  },
  type: 'division',
);
const countrySubdivisionGMBW = CountrySubdivision(
  alpha2: 'GM',
  alpha3: 'GMB',
  code: 'W',
  name: 'Western',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 13.2229202, longitude: -16.5819789),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.4525822, longitude: -15.8103241),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 13.0668175, longitude: -16.8136312)),
  translations: {
    ...
    'zh': '西部區',
    'ccp': '𑄛𑄧𑄏𑄨𑄟𑄴 𑄇𑄮𑄌𑄳𑄑𑄴 𑄓𑄨𑄞𑄨𑄥𑄧𑄚𑄴',
    'mk': 'Западен Округ',
    'no': 'West Coast',
    'ca': 'West Coast',
    'fa': 'ناحیه غربی (گامبیا)'
  },
  type: 'division',
);
