...
const countrySubdivisionPL02 = CountrySubdivision(
  countryCode: 'PL',
  code: '02',
  name: 'Dolnośląskie',
...
const countrySubdivisionPL04 = CountrySubdivision(
  countryCode: 'PL',
  code: '04',
...
const countrySubdivisionPL06 = CountrySubdivision(
  countryCode: 'PL',
  code: '06',
  name: 'Lubelskie',
...
const countrySubdivisionPL08 = CountrySubdivision(
  countryCode: 'PL',
  code: '08',
  name: 'Lubuskie',
...
const countrySubdivisionPL10 = CountrySubdivision(
  countryCode: 'PL',
  code: '10',
  name: 'Łódzkie',
...
const countrySubdivisionPL12 = CountrySubdivision(
  countryCode: 'PL',
  code: '12',
  name: 'Małopolskie',
...
const countrySubdivisionPL14 = CountrySubdivision(
  countryCode: 'PL',
  code: '14',
  name: 'Mazowieckie',
...
const countrySubdivisionPL16 = CountrySubdivision(
  countryCode: 'PL',
  code: '16',
  name: 'Opolskie',
...
const countrySubdivisionPL18 = CountrySubdivision(
  countryCode: 'PL',
  code: '18',
  name: 'Podkarpackie',
...
const countrySubdivisionPL20 = CountrySubdivision(
  countryCode: 'PL',
  code: '20',
  name: 'Podlaskie',
...
const countrySubdivisionPL22 = CountrySubdivision(
  countryCode: 'PL',
  code: '22',
  name: 'Pomorskie',
...
const countrySubdivisionPL24 = CountrySubdivision(
  countryCode: 'PL',
  code: '24',
  name: 'Śląskie',
...
const countrySubdivisionPL26 = CountrySubdivision(
  countryCode: 'PL',
  code: '26',
  name: 'Świętokrzyskie',
...
const countrySubdivisionPL28 = CountrySubdivision(
  countryCode: 'PL',
  code: '28',
...
const countrySubdivisionPL30 = CountrySubdivision(
  countryCode: 'PL',
  code: '30',
  name: 'Wielkopolskie',
...
const countrySubdivisionPL32 = CountrySubdivision(
  countryCode: 'PL',
  code: '32',
