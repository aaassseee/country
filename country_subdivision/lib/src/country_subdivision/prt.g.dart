...
const countrySubdivisionPRT01 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '01',
  name: 'Aveiro',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.6405055, longitude: -8.6537539),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.6545896, longitude: -8.6238121),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.6241712, longitude: -8.665443800000002)),
  translations: {
    'en': 'Aveiro',
    'ar': 'محافظة أفييرو',
    'bg': 'Авейру',
...
const countrySubdivisionPRT02 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '02',
  name: 'Beja',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 38.0153039, longitude: -7.8627308),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.0746209, longitude: -7.8177491),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 37.97009, longitude: -7.959504799999999)),
  translations: {
    'en': 'Beja',
    'ar': 'محافظة بيجا',
    'be': 'Бежа',
...
const countrySubdivisionPRT03 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '03',
  name: 'Braga',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 41.5454486, longitude: -8.426506999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.5841477, longitude: -8.3421791),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.510402, longitude: -8.4806633)),
  translations: {
    'en': 'Braga',
    'ar': 'محافظة براغا',
    'be': 'акруга Брага',
...
const countrySubdivisionPRT04 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '04',
  name: 'Bragança',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 41.8061131, longitude: -6.756737999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.8369891, longitude: -6.7063504),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.7861053, longitude: -6.7907131)),
  translations: {
    'en': 'Bragança',
    'ar': 'محافظة براغانزا',
    'bg': 'Браганса',
...
const countrySubdivisionPRT05 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '05',
  name: 'Castelo Branco',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.8197117, longitude: -7.4964662),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.9093461, longitude: -7.367089999999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.7136873, longitude: -7.5591241)),
  translations: {
    'en': 'Castelo Branco',
    ...
    'no': 'Castelo Branco',
    'fa': 'منطقه کاستلو برانکو'
  },
  type: 'district',
);
const countrySubdivisionPRT06 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '06',
  name: 'Coimbra',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.2033145, longitude: -8.4102573),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.2861477, longitude: -8.322907599999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.1713722, longitude: -8.5096411)),
  translations: {
    'en': 'Coimbra',
    'ar': 'محافظة كويمبرا',
    'be': 'Каімбра',
...
const countrySubdivisionPRT07 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '07',
  name: 'Évora',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 38.571431, longitude: -7.913501999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.6169193, longitude: -7.843514600000001),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.5227211, longitude: -7.9785036)),
  translations: {
    'en': 'Évora',
    'ar': 'محافظة إيفورا',
    'bg': 'Евура',
...
const countrySubdivisionPRT08 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '08',
  name: 'Faro',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 37.0193548, longitude: -7.9304397),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 37.0738998, longitude: -7.8093544),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 36.9617104, longitude: -8.000400599999999)),
  translations: {
    'en': 'Faro',
    'ar': 'محافظة فارو',
    'bg': 'Фару',
...
const countrySubdivisionPRT09 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '09',
  name: 'Guarda',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.5383482, longitude: -7.266131499999998),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.5738913, longitude: -7.1980682),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.50446, longitude: -7.2926517)),
  translations: {
    'en': 'Guarda',
    'ar': 'محافظة غواردا',
    'bg': 'Гуарда',
...
const countrySubdivisionPRT10 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '10',
  name: 'Leiria',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.74953310000001, longitude: -8.807682999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.798205, longitude: -8.7350657),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.70991799999999, longitude: -8.8768517)),
  translations: {
    'en': 'Leiria',
    'ar': 'محافظة ليريا',
    'bg': 'Лейрия',
...
const countrySubdivisionPRT11 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '11',
  name: 'Lisboa',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.7958538, longitude: -9.0905718),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.6913994, longitude: -9.2298356)),
  translations: {
    'en': 'Lisbon',
    'ar': 'محافظة لشبونة',
    'be': 'акруга Лісабон',
    ...
    'ccp': '𑄣𑄨𑄌𑄴𑄝𑄧𑄚𑄴',
    'no': 'Lisboa',
    'el': 'διαμέρισμα της Λισαβόνας',
    'hy': 'Լիսաբոն',
    'tr': 'Lizbon (ilçe)'
  },
  type: 'district',
);
const countrySubdivisionPRT12 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '12',
  name: 'Portalegre',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.2967086, longitude: -7.4284755),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.3153866, longitude: -7.3995175),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.262495, longitude: -7.4664739)),
  translations: {
    'en': 'Portalegre',
    ...
    'no': 'Portalegre',
    'el': 'διαμέρισμα του Πορταλέγκρε',
    'fa': 'ناحیه پورتالگر',
    'tr': 'Portalegre (ilçe)'
  },
  type: 'district',
);
const countrySubdivisionPRT13 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '13',
  name: 'Porto',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 41.1579438, longitude: -8.629105299999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.1859353, longitude: -8.5526134),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.1383506, longitude: -8.6910927)),
  translations: {
    'en': 'Porto',
    'ar': 'محافظة بورتو',
    'be': 'акруга Порту',
    ...
    'az': 'Portu dairəsi',
    'cy': 'Ardal Porto',
    'el': 'διαμέρισμα του Πόρτο',
    'fa': 'منطقه پورتو',
    'tr': 'Porto (ilçe)'
  },
  type: 'district',
);
const countrySubdivisionPRT14 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '14',
  name: 'Santarém',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.2366618, longitude: -8.686011900000002),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.2869109, longitude: -8.626665299999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.1687465, longitude: -8.7494918)),
  translations: {
    'en': 'Santarém',
    'ar': 'محافظة سانتاريم',
    'bg': 'Сантарем',
...
const countrySubdivisionPRT15 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '15',
  name: 'Setúbal',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 38.5260437, longitude: -8.8909328),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.5641093, longitude: -8.7556919),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.4840016, longitude: -8.9725114)),
  translations: {
    'en': 'Setúbal',
    'ar': 'محافظة سيتوبال',
    'be': 'акруга Сетубал',
...
const countrySubdivisionPRT16 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '16',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 41.6918275, longitude: -8.8344101),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.7605686, longitude: -8.7483575),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.6714037, longitude: -8.8693403)),
  translations: {
    'en': 'Viana do Castelo',
    ...
    'ccp': '𑄞𑄨𑄠𑄚 𑄓𑄮 𑄇𑄌𑄴𑄑𑄬𑄣𑄮',
    'no': 'Viana do Castelo',
    'fa': 'منطقه ویانا دو کاستلو'
  },
  type: 'district',
);
const countrySubdivisionPRT17 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '17',
  name: 'Vila Real',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 41.3010351, longitude: -7.7422354),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.3635472, longitude: -7.6639146),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.2401615, longitude: -7.790294800000001)),
  translations: {
    'en': 'Vila Real',
    'ar': 'محافظة فيلا ريال',
    'bg': 'Виля Реал',
...
const countrySubdivisionPRT18 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '18',
  name: 'Viseu',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.6565861, longitude: -7.9124712),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.7325793, longitude: -7.8250273),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.6072458, longitude: -7.9660481)),
  translations: {
    'en': 'Viseu',
    'ar': 'محافظة فيسيو',
    'bg': 'Визеу',
...
const countrySubdivisionPRT20 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '20',
  name: 'Açores',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 37.7412488, longitude: -25.6755944),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.7261497, longitude: -25.0131855),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 36.9278178, longitude: -31.2687948)),
  translations: {
    'en': 'Azores',
    'af': 'Asore',
    'ar': 'الأزور',
...
const countrySubdivisionPRT30 = CountrySubdivision(
  alpha2: 'PT',
  alpha3: 'PRT',
  code: '30',
  name: 'Madeira',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 32.76070740000001, longitude: -16.9594723),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 33.1281375, longitude: -15.8566922),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.0303451, longitude: -17.2659373)),
  translations: {
    'en': 'Madeira',
    'af': 'Madeiraeilande',
    'ar': 'جزر ماديرا',
