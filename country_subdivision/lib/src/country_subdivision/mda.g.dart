...
const countrySubdivisionMDAAN = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'AN',
  name: 'Anenii Noi',
...
const countrySubdivisionMDABA = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'BA',
  name: 'Balti',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.7539947, longitude: 27.9184148),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.81119469999999, longitude: 27.9682947),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.7226969, longitude: 27.8344632)),
  translations: {
    'en': 'Bălţi',
    'af': 'Bălţi',
    'am': 'በልጺ',
...
const countrySubdivisionMDABD = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'BD',
  name: 'Bender [Tighina]',
...
const countrySubdivisionMDABR = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'BR',
  name: 'Briceni',
...
const countrySubdivisionMDABS = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'BS',
  name: 'Basarabeasca',
...
const countrySubdivisionMDACA = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'CA',
  name: 'Cahul',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 45.8939404, longitude: 28.1890275),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.9423021, longitude: 28.231709),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 45.8736666, longitude: 28.1741595)),
  translations: {
    'en': 'Cahul',
    'ar': 'مقاطعة كاهول',
    'bg': 'Кахулски район',
...
const countrySubdivisionMDACL = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'CL',
  name: 'Călărași',
...
const countrySubdivisionMDACM = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'CM',
  name: 'Cimișlia',
...
const countrySubdivisionMDACR = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'CR',
  name: 'Criuleni',
...
const countrySubdivisionMDACS = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'CS',
  name: 'Căușeni',
...
const countrySubdivisionMDACT = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'CT',
  name: 'Cantemir',
...
const countrySubdivisionMDACU = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'CU',
  name: 'Chisinau',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.0240102, longitude: 28.8313156),
      maxCoordinate: null,
      minCoordinate: null),
  translations: {
    'en': 'Chișinău',
...
const countrySubdivisionMDADO = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'DO',
  name: 'Dondușeni',
...
const countrySubdivisionMDADR = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'DR',
  name: 'Drochia',
...
const countrySubdivisionMDADU = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'DU',
  name: 'Dubăsari',
...
const countrySubdivisionMDAED = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'ED',
  name: 'Edinet',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 48.1678991, longitude: 27.2936143),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.1892079, longitude: 27.3280621),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.1522871, longitude: 27.2787093)),
  translations: {
    'en': 'Edineț',
    'ar': 'مقاطعة إيدينت',
    'bg': 'Единецки район',
...
const countrySubdivisionMDAFA = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'FA',
  name: 'Fălești',
...
const countrySubdivisionMDAFL = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'FL',
  name: 'Florești',
...
const countrySubdivisionMDAGA = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'GA',
  ...
  type: 'autonomous_territorial_unit',
);
const countrySubdivisionMDAGL = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'GL',
  name: 'Glodeni',
...
const countrySubdivisionMDAHI = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'HI',
  name: 'Hîncești',
...
const countrySubdivisionMDAIA = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'IA',
  name: 'Ialoveni',
...
const countrySubdivisionMDALE = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'LE',
  name: 'Leova',
...
const countrySubdivisionMDANI = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'NI',
  name: 'Nisporeni',
...
const countrySubdivisionMDAOC = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'OC',
  name: 'Ocnița',
...
const countrySubdivisionMDAOR = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'OR',
  name: 'Orhei',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.383333, longitude: 28.816667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.40391169999999, longitude: 28.8649678),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.333195, longitude: 28.7943291)),
  translations: {
    'en': 'Orhei',
    'ar': 'مقاطعة أورهي',
    'bg': 'Орхеевски район',
...
const countrySubdivisionMDARE = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'RE',
  name: 'Rezina',
...
const countrySubdivisionMDARI = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'RI',
  name: 'Rîșcani',
...
const countrySubdivisionMDASD = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'SD',
  name: 'Șoldănești',
...
const countrySubdivisionMDASI = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'SI',
  name: 'Sîngerei',
...
const countrySubdivisionMDASN = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'SN',
...
const countrySubdivisionMDASO = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'SO',
  name: 'Soroca',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate:
          CountrySubdivisionCoordinate(latitude: 48.166667, longitude: 28.3),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.1874054, longitude: 28.3286763),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 48.1209551, longitude: 28.2504846)),
  translations: {
    'en': 'Soroca',
    'ar': 'مقاطعة سوروكا',
    'bg': 'Сорокски район',
...
const countrySubdivisionMDAST = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'ST',
  name: 'Strășeni',
...
const countrySubdivisionMDASV = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'SV',
  name: 'Ștefan Vodă',
...
const countrySubdivisionMDATA = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'TA',
  name: 'Taraclia',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 46.5703, longitude: 29.11559999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.5827462, longitude: 29.1362143),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 46.547203, longitude: 29.0931702)),
  translations: {
    'en': 'Taraclia',
    'ar': 'مقاطعة تاراكليا',
    'be': 'Тараклійскі раён',
...
const countrySubdivisionMDATE = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'TE',
  name: 'Telenești',
...
const countrySubdivisionMDAUN = CountrySubdivision(
  alpha2: 'MD',
  alpha3: 'MDA',
  code: 'UN',
  name: 'Ungheni',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 47.216667, longitude: 27.816667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.2493487, longitude: 27.8279203),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 47.1690154, longitude: 27.7592753)),
  translations: {
    'en': 'Ungheni',
    'ar': 'مقاطعة اونغيني',
    'bg': 'Унгенски район',
