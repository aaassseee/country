...
const countrySubdivisionGHAAA = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'AA',
  name: 'Greater Accra',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 5.8142836, longitude: 0.0746767),
      maxCoordinate:
          CountrySubdivisionCoordinate(latitude: 5.9961559, longitude: 0.72458),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.4948349, longitude: -0.5112099999999999)),
  translations: {
    'en': 'Greater Accra',
...
const countrySubdivisionGHAAF = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'AF',
  name: 'Ahafo',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.1750308, longitude: 1.199972),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.6339001, longitude: -3.2607859)),
  translations: {
    'en': 'Ahafo',
    'de': 'Ahafo Region',
    'es': 'Región Ahafo',
...
const countrySubdivisionGHAAH = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'AH',
  name: 'Ashanti',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.7470436, longitude: -1.5208624),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.621659999999999, longitude: -0.222413),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.853753999999999, longitude: -2.451715)),
  translations: {
    'en': 'Ashanti',
    'ar': 'منطقة أشانتي',
    'be': 'рэгіён Ашанці',
...
const countrySubdivisionGHABE = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'BE',
  name: 'Bono East',
...
const countrySubdivisionGHABO = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'BO',
  name: 'Bono',
...
const countrySubdivisionGHACP = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'CP',
  name: 'Central',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 5.5607846, longitude: -1.0586135),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 6.3042729, longitude: -0.369136),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.0336656, longitude: -2.176695)),
  translations: {
    'en': 'Central',
    'ar': 'الإقليم الأوسط',
...
const countrySubdivisionGHAEP = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'EP',
  name: 'Eastern',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.237403599999999, longitude: -0.4502368),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.186541000000001, longitude: 0.322644),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.729348, longitude: -1.2483401)),
  translations: {
    'en': 'Eastern',
    'ar': 'الإقليم الشرقي',
    'be': 'Усходні рэгіён',
...
const countrySubdivisionGHANE = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'NE',
  name: 'North East',
...
const countrySubdivisionGHANP = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'NP',
  name: 'Northern',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 9.543926899999999, longitude: -0.9056623),
      maxCoordinate:
          CountrySubdivisionCoordinate(latitude: 10.714593, longitude: 0.56338),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.954847000000001, longitude: -2.779666)),
  translations: {
    'en': 'Northern',
    'ar': 'الإقليم الشمالي',
    'be': 'Паўночны рэгіён',
...
const countrySubdivisionGHAOT = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'OT',
  name: 'Oti',
...
const countrySubdivisionGHASV = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'SV',
  name: 'Savannah',
...
const countrySubdivisionGHATV = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'TV',
  name: 'Volta',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 6.5781373, longitude: 0.4502368),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 8.754108, longitude: 1.1917686),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 5.7696366, longitude: -0.3436661)),
  translations: {
    'en': 'Volta',
    'ar': 'إقليم فولتا',
    'be': 'Рэгіён Вольта',
...
const countrySubdivisionGHAUE = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'UE',
  name: 'Upper East',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.7082499, longitude: -0.9820667999999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.173301, longitude: 0.032068),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 10.270471, longitude: -1.575864)),
  translations: {
    'en': 'Upper East',
...
const countrySubdivisionGHAUW = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'UW',
  name: 'Upper West',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 10.2529757, longitude: -2.1450245),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 11.0189701, longitude: -1.3693439),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 9.6529639, longitude: -2.9455968)),
  translations: {
    'en': 'Upper West',
...
const countrySubdivisionGHAWN = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'WN',
  name: 'Western North',
...
const countrySubdivisionGHAWP = CountrySubdivision(
  alpha2: 'GH',
  alpha3: 'GHA',
  code: 'WP',
  name: 'Western',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 5.3901978, longitude: -2.1450245),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 7.052660899999999, longitude: -1.417818),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 4.738815, longitude: -3.25542)),
  translations: {
    'en': 'Western',
    'ar': 'الإقليم الغربي',
    'be': 'Заходні рэгіён',
