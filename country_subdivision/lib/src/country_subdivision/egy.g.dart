...
const countrySubdivisionEGYALX = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'ALX',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.330904, longitude: 30.0864016),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.1173177, longitude: 29.8233701)),
  translations: {
    'en': 'Alexandria',
    'ar': 'الإسكندرية',
    ...
    'az': 'əl-İskəndəriyyə mühafəzəsi',
    'so': 'Alexandria Governorate',
    'yue': '亞歷山大省',
    'yue_Hans': '亚历山大省',
    'zu': 'Alexandria Governorate'
  },
  type: 'governorate',
);
const countrySubdivisionEGYASN = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'ASN',
  name: 'Aswan',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 24.088938, longitude: 32.8998293),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 24.1131931, longitude: 32.9207739),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 24.0714761, longitude: 32.8794385)),
  translations: {
    'en': 'Aswan',
    'ar': 'محافظة أسوان',
    'be': 'Мухафаза Асуан',
    ...
    'az': 'Əsvan mühafəzəsi',
    'mk': 'Асуан (област)',
    'th': 'เขตผู้ว่าการอัสวาน',
    'yue': '阿斯旺省',
    'yue_Hans': '阿斯旺省'
  },
  type: 'governorate',
);
const countrySubdivisionEGYAST = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'AST',
  name: 'Asyut',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 27.1783117, longitude: 31.1859257),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 27.1960162, longitude: 31.2121548),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 27.1580509, longitude: 31.1566813)),
  translations: {
    'en': 'Asyut',
    'ar': 'أسيوط',
    'be': 'Мухафаза Асьют',
...
const countrySubdivisionEGYBA = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'BA',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 25.1076838, longitude: 33.7964613),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.3923378, longitude: 36.8945141),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.9996377, longitude: 30.741445)),
  translations: {
    'en': 'Red Sea',
    'ar': 'البحر الأحمر',
    'bg': 'Червено море',
    ...
    'az': 'Qırmızı dəniz mühafəzəsi',
    'mk': 'Црвено Море (област)'
  },
  type: 'governorate',
);
const countrySubdivisionEGYBH = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'BH',
  name: 'Al Buhayrah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.8480986, longitude: 30.3435506),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.4683007, longitude: 30.8513688),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.9339286, longitude: 29.5338788)),
  translations: {
    'en': 'Beheira',
    'ar': 'محافظة البحيرة',
    'be': 'Мухафаза Бухейра',
    ...
    'az': 'əl-Büheyrə mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYBNS = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'BNS',
  name: 'Bani Suwayf',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 29.0661274, longitude: 31.0993845),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.0958994, longitude: 31.1423418),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.0058847, longitude: 31.0616271)),
  translations: {
    'en': 'Beni Suef',
    'ar': 'بني سويف',
    ...
    'az': 'Bəni Süveyf mühafəzəsi',
    'mk': 'Бени Суејф (област)'
  },
  type: 'governorate',
);
const countrySubdivisionEGYC = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'C',
  name: 'Al Qahirah',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.1106024, longitude: 31.3019729),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.0083745, longitude: 31.2149558)),
  translations: {
    'en': 'Cairo',
    'ar': 'محافظة القاهرة',
    'be': 'Мухафаза Каір',
    ...
    'az': 'əl-Qahirə mühafəzəsi',
    'cy': 'Llywodraethiaeth Cairo',
    'eu': 'Kairoko gobernazioa',
    'ga': 'Gobharnóireacht Chaireo'
  },
  type: 'governorate',
);
const countrySubdivisionEGYDK = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'DK',
  name: 'Ad Daqahliyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 31.0832017, longitude: 31.4913182),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.5452581, longitude: 32.0835976),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.5769786, longitude: 31.2086064)),
  translations: {
    'en': 'Dakahlia',
    'ar': 'الدقهلية',
    'be': 'Дакахлія',
    ...
    'bs': 'Dakahlia',
    'no': 'Ad Daqahliyah',
    'az': 'əd-Dəqəhliyyə mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYDT = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'DT',
  name: 'Dumyat',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 31.4175388, longitude: 31.81444339999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.4417822, longitude: 31.8280067),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.3934849, longitude: 31.7816078)),
  translations: {
    'en': 'Damietta',
    'ar': 'محافظة دمياط',
    'bg': 'Дамиета',
    ...
    'az': 'Dümyat mühafəzəsi',
    'he': 'דמיאט'
  },
  type: 'governorate',
);
const countrySubdivisionEGYFYM = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'FYM',
  name: 'Al Fayyum',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 29.3084021, longitude: 30.8428497),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.3299673, longitude: 30.86388549999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.2918259, longitude: 30.8206875)),
  translations: {
    'en': 'Faiyum',
    'ar': 'محافظة الفيوم',
    'bg': 'Фаюм',
    ...
    'az': 'əl-Fəyyum mühafəzəsi',
    'th': 'เขตผู้ว่าการอัลฟัยยูม'
  },
  type: 'governorate',
);
const countrySubdivisionEGYGH = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'GH',
  name: 'Al Gharbiyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.8753556, longitude: 31.03351),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.1583532, longitude: 31.3105264),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.5747929, longitude: 30.7465372)),
  translations: {
    'en': 'Gharbia',
    'ar': 'الغربية',
    'bg': 'Гарбия',
    ...
    'az': 'əl-Qərbiyyə mühafəzəsi',
    'be': 'мухафаза Гарбія',
    'hu': 'Gharbijja'
  },
  type: 'governorate',
);
const countrySubdivisionEGYGZ = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'GZ',
  name: 'Al Jizah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.0130557, longitude: 31.2088526),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.0714063, longitude: 31.2320457),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.9621703, longitude: 31.1472406)),
  translations: {
    'en': 'Giza',
    'ar': 'محافظة الجيزة',
    'be': 'Эль-Гіза',
    ...
    'az': 'əl-Cizə mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYIS = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'IS',
  name: 'Al Ismā`īlīyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.5830934, longitude: 32.2653887),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.0059587, longitude: 32.7520118),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.2436079, longitude: 31.6954456)),
  translations: {
    'en': 'Ismailia',
    'ar': 'الإسماعيلية',
    'bg': 'Исмаилия',
    ...
    'az': 'əl-İsmailiyyə mühafəzəsi',
    'mk': 'Исмаилија (област)'
  },
  type: 'governorate',
);
const countrySubdivisionEGYJS = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'JS',
  name: 'Janub Sina\'',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 29.3101828, longitude: 34.1531947),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.9494465, longitude: 34.9076691),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 27.7240277, longitude: 32.6094505)),
  translations: {
    'en': 'South Sinai',
    'ar': 'جنوب سيناء',
    'bg': 'Южен Синай',
    ...
    'az': 'Cənubi Sina mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYKB = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'KB',
  name: 'Al Qalyubiyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.3292368, longitude: 31.2168466),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.6076595, longitude: 31.4157302),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.1040552, longitude: 31.0542669)),
  translations: {
    'en': 'Qalyubia',
    'ar': 'محافظة القليوبية',
    'bg': 'Калюбия',
    ...
    'bs': 'Qalyubia',
    'no': 'Al Qalyubiyah',
    'az': 'əl-Qəlyubiyyə mühafəzəsi',
    'hy': 'Քալյուբիա'
  },
  type: 'governorate',
);
const countrySubdivisionEGYKFS = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'KFS',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 31.3085444, longitude: 30.8039474),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.6016217, longitude: 31.3122298),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.9942465, longitude: 30.3653976)),
  translations: {
    'en': 'Kafr el-Sheikh',
    'ar': 'محافظة كفر الشيخ',
    'bg': 'Кафър ел-Шейх',
    ...
    'bs': 'Kafr el-Sheikh',
    'no': 'Kafr ash Shaykh',
    'az': 'Kəfr əş-Şeyx mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYKN = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'KN',
  name: 'Qina',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 26.155061, longitude: 32.7160121),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 26.2104418, longitude: 32.7601361),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 26.1320478, longitude: 32.6828284)),
  translations: {
    'en': 'Qena',
    'ar': 'محافظة قنا',
    'be': 'Кена',
...
const countrySubdivisionEGYLX = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'LX',
  name: 'al-Uqsur',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 25.6872431, longitude: 32.6396357),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 25.7358046, longitude: 32.6964268),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 25.6540777, longitude: 32.6225071)),
  translations: {
    'en': 'Luxor',
    'ar': 'محافظة الأقصر',
    'be': 'Луксор',
    ...
    'az': 'əl-Üqsür mühafəzəsi',
    'id': 'Kegubernuran Luxor',
    'mk': 'Луксор (област)',
    'th': 'เขตผู้ว่าการลักซอร์'
  },
  type: 'governorate',
);
const countrySubdivisionEGYMN = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'MN',
  name: 'Al Minya',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 28.0870967, longitude: 30.7618397),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 28.1318404, longitude: 30.7843728),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 28.058606, longitude: 30.7170696)),
  translations: {
    'en': 'Minya',
    'ar': 'المنيا',
    'be': 'Эль-Мінья',
    ...
    'az': 'əl-Minya mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYMNF = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'MNF',
  name: 'Al Minufiyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.5972455, longitude: 30.9876321),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.7480879, longitude: 31.2559327),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.1829009, longitude: 30.4745556)),
  translations: {
    'en': 'Monufia',
    'ar': 'محافظة المنوفية',
    'bg': 'Минуфия',
    ...
    'az': 'əl-Minufiyyə mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYMT = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'MT',
  name: 'Matrūh',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 31.3543445, longitude: 27.2373159),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.3761768, longitude: 27.3544331),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.2970958, longitude: 27.156232)),
  translations: {
    'en': 'Matrouh',
    'ar': 'محافظة مطروح',
    'bg': 'Матрух',
    ...
    'az': 'Mətruh mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYPTS = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'PTS',
  name: 'Būr Sa`īd',
  ...
  geo: CountrySubdivisionGeoData(
      ...
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.2784705, longitude: 32.3213102),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.1988856, longitude: 32.2490287)),
  translations: {
    'en': 'Port Said',
    'ar': 'بورسعيد',
    ...
    'bs': 'Port Said',
    'no': 'Bur Sa’id',
    'az': 'Port-Səid mühafəzəsi',
    'uz': 'Port Said Gubernatorligi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYSHG = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'SHG',
  name: 'Suhaj',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 26.501348, longitude: 31.76513619999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 26.9343956, longitude: 32.1707085),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 26.1518194, longitude: 31.3415418)),
  translations: {
    'en': 'Sohag',
    'ar': 'محافظة سوهاج',
    'bg': 'Сухадж',
    ...
    'bs': 'Sohag',
    'no': 'Suhaj',
    'az': 'Sövhac mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYSHR = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'SHR',
  name: 'Ash Sharqiyah',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.7326622, longitude: 31.7195459),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.168795, longitude: 32.1782565),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.2886886, longitude: 31.2607672)),
  translations: {
    'en': 'Al Sharqia',
    'ar': 'الشرقية',
    'bg': 'Шаркия',
    ...
    'bs': 'Sharqia',
    'no': 'Ash Sharqiyah',
    'az': 'əş-Şərqiyyə mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYSIN = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'SIN',
  name: 'Shamal Sina\'',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 30.6084723, longitude: 33.617577),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 31.3314092, longitude: 34.8774622),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.5932723, longitude: 32.554564)),
  translations: {
    'en': 'North Sinai',
    'ar': 'شمال سيناء',
    'bg': 'Северен Синай',
    ...
    'az': 'Şimali Sina mühafəzəsi'
  },
  type: 'governorate',
);
const countrySubdivisionEGYSUZ = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'SUZ',
  name: 'As Suways',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 29.9668343, longitude: 32.5498069),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 30.0211813, longitude: 32.5854957),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 29.9329452, longitude: 32.4374941)),
  translations: {
    'en': 'Suez',
    'ar': 'السويس',
    'bg': 'Суец',
    ...
    'bs': 'Suez',
    'no': 'As Suways',
    'az': 'Süveyş mühafəzəsi',
    'cy': 'Llywodraethiaeth Suez',
    'mk': 'Суец (област)'
  },
  type: 'governorate',
);
const countrySubdivisionEGYWAD = CountrySubdivision(
  alpha2: 'EG',
  alpha3: 'EGY',
  code: 'WAD',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 24.5455638, longitude: 27.1735316),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 27.6966292, longitude: 32.9224299),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 21.9915523, longitude: 25.0003101)),
  translations: {
    'en': 'New Valley',
