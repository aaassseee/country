...
const countrySubdivisionBLRBR = CountrySubdivision(
  alpha2: 'BY',
  alpha3: 'BLR',
  code: 'BR',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 52.5296641, longitude: 25.460648),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.4118989, longitude: 27.5825019),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.4980539, longitude: 23.1783377)),
  translations: {
    'en': 'Brest',
    'ar': 'بريست أوبلاست',
    'az': 'Brest vilayəti',
...
const countrySubdivisionBLRHM = CountrySubdivision(
  alpha2: 'BY',
  alpha3: 'BLR',
  code: 'HM',
  name: 'Мінск',
...
const countrySubdivisionBLRHO = CountrySubdivision(
  alpha2: 'BY',
  alpha3: 'BLR',
  code: 'HO',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 52.1648754, longitude: 29.1333251),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 53.3679551, longitude: 31.7992701),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 51.2620722, longitude: 27.2441409)),
  translations: {
    'en': 'Homel',
    'ar': 'غومل أوبلاست',
    'az': 'Qomel vilayəti',
...
const countrySubdivisionBLRHR = CountrySubdivision(
  alpha2: 'BY',
  alpha3: 'BLR',
  code: 'HR',
...
const countrySubdivisionBLRMA = CountrySubdivision(
  alpha2: 'BY',
  alpha3: 'BLR',
  code: 'MA',
...
const countrySubdivisionBLRMI = CountrySubdivision(
  alpha2: 'BY',
  alpha3: 'BLR',
  code: 'MI',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 53.4718561, longitude: 27.6969909),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 55.017477, longitude: 29.487841),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 52.37261179999999, longitude: 26.06101)),
  translations: {
    'en': 'Minsk Region',
    'ar': 'إقليم مينسك',
    'az': 'Minsk vilayəti',
...
const countrySubdivisionBLRVI = CountrySubdivision(
  alpha2: 'BY',
  alpha3: 'BLR',
  code: 'VI',
