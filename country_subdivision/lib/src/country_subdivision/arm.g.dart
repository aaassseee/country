...
const countrySubdivisionARMAG = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'AG',
  name: 'Aragacotn',
  ...
  translations: {
    ...
    'mk': 'Арагацотн',
    'no': 'Aragatsotn',
    'ml': 'അരഗത്സോട്ൻ പ്രവിശ്യ'
  },
  type: 'region',
);
const countrySubdivisionARMAR = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'AR',
  name: 'Ararat',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.9753273, longitude: 44.8338058),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.189931, longitude: 45.11704899999999),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.713722, longitude: 44.3149281)),
  translations: {
    'en': 'Ararat',
    'ar': 'محافظة أرارات',
    'az': 'Ararat mərzi',
    ...
    'no': 'Ararat',
    'cy': 'Talaith Ararat',
    'ml': 'അരാരത്ത് പ്രവിശ്യ',
    'yue': '亞拉拉特省',
    'yue_Hans': '亚拉拉特省'
  },
  type: 'region',
);
const countrySubdivisionARMAV = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'AV',
  name: 'Armavir',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.1315615, longitude: 43.8325355),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.283289, longitude: 44.4403099),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.01846700000001, longitude: 43.6464811)),
  translations: {
    'en': 'Armavir',
    'ar': 'محافظة آرماوير',
    'az': 'Armavir mərzi',
...
const countrySubdivisionARMER = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'ER',
  name: 'Erevan',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.183333, longitude: 44.516667),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.2426667, longitude: 44.6150493),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.0641141, longitude: 44.3620849)),
  translations: {
    'en': 'Yerevan',
    'af': 'Jerewan',
    'am': 'ዬሬቫን',
...
const countrySubdivisionARMGR = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'GR',
  name: 'Gegark\'unik\'',
...
const countrySubdivisionARMKT = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'KT',
  name: 'Kotayk\'',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.4277896, longitude: 44.6641741),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.71982999999999, longitude: 45.043105),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.0972899, longitude: 44.398311)),
  translations: {
    'en': 'Kotayk',
    'ar': 'محافظة كوتايك',
    'az': 'Kotayk mərzi',
    ...
    'no': 'Kotajk',
    'he': 'מחוז קוטאיק',
    'ml': 'കോട്ടയ്ക് പ്രവിശ്യ',
    'yue': '戈泰克省',
    'yue_Hans': '戈泰克省'
  },
  type: 'region',
);
const countrySubdivisionARMLO = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'LO',
  name: 'Lory',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.969845, longitude: 44.490014),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.299259, longitude: 44.960212),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.668043, longitude: 44.016761)),
  translations: {
    'en': 'Lori',
    'ar': 'محافظة لوري',
    'az': 'Loru mahalı',
...
const countrySubdivisionARMSH = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'SH',
  name: 'Širak',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.9630814, longitude: 43.8102461),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.1808931, longitude: 44.2037191),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.439465, longitude: 43.4497797)),
  translations: {
    'en': 'Shirak',
    'ar': 'محافظة شيراك',
    'az': 'Amasiya',
    ...
    'mk': 'Ширак',
    'no': 'Sjirak',
    'ml': 'ഷിറാക്ക് പ്രവിശ്യ',
    'yue': '斯拉克省',
    'yue_Hans': '斯拉克省'
  },
  type: 'region',
);
const countrySubdivisionARMSU = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'SU',
  name: 'Syunik\'',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.3194392, longitude: 46.14609189999999),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.854328, longitude: 46.630035),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 38.830521, longitude: 45.70893909999999)),
  translations: {
    'en': 'Syunik',
    'ar': 'محافظة سيونيك',
    'az': 'Sünik',
    ...
    'mk': 'Сјуник',
    'no': 'Syunik',
    'ml': 'സ്യൂനിക് പ്രവിശ്യ',
    'yue': '蕭力省',
    'yue_Hans': '萧力省'
  },
  type: 'region',
);
const countrySubdivisionARMTV = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'TV',
  name: 'Tavuš',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 40.8866296, longitude: 45.339349),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 41.3018379, longitude: 45.5956799),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.648954, longitude: 44.766082)),
  translations: {
    'en': 'Tavush',
    'ar': 'محافظة تاووش',
    'az': 'Tavuş',
...
const countrySubdivisionARMVD = CountrySubdivision(
  alpha2: 'AM',
  alpha3: 'ARM',
  code: 'VD',
  name: 'Vayoc Jor',
  ...
  geo: CountrySubdivisionGeoData(
      coordinate: CountrySubdivisionCoordinate(
          latitude: 39.8107912, longitude: 45.4967174),
      maxCoordinate: CountrySubdivisionCoordinate(
          latitude: 40.01380899999999, longitude: 45.825905),
      minCoordinate: CountrySubdivisionCoordinate(
          latitude: 39.502243, longitude: 45.066502)),
  translations: {
    'en': 'Vayots Dzor',
    'ar': 'محافظة وايوتس‌جور',
    'az': 'Dərələyəz mahalı',
    'be': 'Марз Ваёц-Дзор',
    'bg': 'Вайоц Дзор',
    'bn': 'ভায়োত জুর অঞ্চল',
